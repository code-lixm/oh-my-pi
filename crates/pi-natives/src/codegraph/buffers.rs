...
//!   1   u8   visibility (0 absent, 1 public, 2 private, 3 protected, 4
//! internal)   2   u16  bool flags — bit pairs (present, value):
...
//!   36  str  id (kernel-computed: "kind:hash32", or "file:<path>" for the file
//! node)   44  str  docstring
//!   52  str  signature
