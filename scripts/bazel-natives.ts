 ...
 *
 * On win32, Bazel's MSVC cross toolchain cannot run on the host, but real MSVC
 * can; use the local N-API build and install it into destDir like the Bazel path.
 */
