...
- Added runtime-registerable usage provider adapters with source-layered replacement, canonical report validation, explicit currency metadata, and broker/client report merging for locally configured providers.
