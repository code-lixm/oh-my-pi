...
export interface SimpleStreamOptions extends Omit<StreamOptions, "apiKey"> {
	...
	/** Amazon Bedrock Guardrail identifier or ARN for Converse requests. */
	guardrailIdentifier?: string;
	/** Amazon Bedrock Guardrail version; omitted uses the provider's DRAFT projection. */
	guardrailVersion?: string;
	/** Amazon Bedrock Guardrail trace verbosity. */
