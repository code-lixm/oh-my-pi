...
const en: Catalog = {
	...
	// overview route
	"overview.tokenUsage.title": "Conversation Tokens by Agent",
	"overview.tokenUsage.subtitle": "Uncached input + cache reads + cache writes + output, grouped by agent type",
	"overview.metric.totalCost": "Total Cost",
	"overview.metric.requests": "Requests",
	"overview.metric.cacheRate": "Cache Rate",
	"overview.metric.cacheSavings": "Cache Savings",
	"overview.metric.cacheSavingsTitle":
		"Prompt-input cost saved versus billing the same tokens uncached; cache writes can make this negative",
	"overview.metric.cacheRateTitle": "Prompt input served from cache: cache reads / (uncached input + cache reads)",
	"overview.metric.errorRate": "Error Rate",
	"overview.metric.uncachedInput": "Uncached Input",
	"overview.metric.uncachedInputTitle": "Conversation input not served from cache",
	"overview.metric.cacheRead": "Cache Read",
	"overview.metric.cacheReadTitle": "Conversation input read from the prompt cache",
	"overview.metric.outputTokens": "Output Tokens",
	"overview.metric.conversationTotal": "Conversation Total",
	"overview.metric.conversationTotalTitle": "Uncached input + cache reads + cache writes + output",
	"overview.metric.premiumRequests": "Premium Requests",
	"overview.metric.tokensPerSecond": "Tokens/s",
	"overview.metric.avgLatency": "Avg Latency",
	"overview.metric.avgTtft": "Avg TTFT",
	...
	"models.expanded.cacheSavings": "Cache savings",
	...
	"tools.table.column.avgDuration": "Avg. Time",
	"tools.table.avgDurationTitle": "Elapsed time from the assistant tool call to its result",
	...
	"providers.totals.tokensTitle":
		"Input {input} · Output {output} · Cache read {cacheRead} · Cache write {cacheWrite}",
	"providers.column.provider": "Provider",
	"providers.column.requests": "Requests",
	"providers.column.errorRate": "Error Rate",
	"providers.column.models": "Models",
	"providers.column.tokens": "Tokens",
	"providers.column.share": "Share",
	"providers.column.cost": "Cost",
	"providers.column.tps": "Tok/s",
	"providers.trend.title": "Burn by Provider",
	"providers.trend.subtitle": "Stacked token/cost burn per provider over time",
	"providers.trend.metric.tokens": "Tokens",
	"providers.trend.metric.cost": "Cost",
	"providers.trend.empty": "No provider activity in this range",
	"providers.trend.footerTotal": "Total: {value}",
	"providers.peakHours.title": "Peak Burn Hours",
	"providers.peakHours.subtitle": "Token burn by local hour of day",
	"providers.peakHours.subtitlePeak": "Token burn by local hour of day - peak at {time}",
	"providers.peakHours.ariaLabel": "Provider",
	"providers.peakHours.allProviders": "All providers",
	"providers.peakHours.empty": "No activity in this range",
	...
	"providers.windows.column.window": "Window",
	"providers.windows.column.accounts": "Accounts",
	"providers.windows.column.consumed": "Windows Burned",
	"providers.windows.column.capacity": "Est. Tokens / Window",
	"providers.windows.column.peak": "Peak Utilization",
	"providers.windows.column.ideal": "Ideal Accounts",
	"providers.windows.column.exhausted": "Exhaustions",
	"providers.windows.consumedTitle":
		"Subscription-window equivalents consumed in range (sum of used-fraction increases across accounts)",
	"providers.windows.capacityTitle":
		"Provider tokens burned in range ÷ windows burned - what one full window is worth",
	"providers.windows.peakTitle": "Peak of summed used fraction across accounts at any sampled instant",
	"providers.windows.idealTitle": "Accounts needed to keep peak demand under 90% of fleet capacity",
	"providers.windows.idealHave": " (have {n})",
	...
	"providers.utilization.ariaLabel": "Provider",
	"providers.utilization.empty": "No usage snapshots recorded yet - they accumulate whenever usage is fetched",
	"providers.utilization.label.used": "Used",
	"providers.utilization.tooltip.used": "{value}% used",
	"providers.utilization.tooltip.recorded": "{used} · recorded {time}",
};
...
const zhCN: Catalog = {
	...
	// overview route
	"overview.tokenUsage.title": "按 Agent 划分的对话 Token",
	"overview.tokenUsage.subtitle": "未缓存输入 + 缓存读取 + 缓存写入 + 输出，按 Agent 类型分组",
	"overview.metric.totalCost": "总成本",
	"overview.metric.requests": "请求数",
	"overview.metric.cacheRate": "缓存率",
	"overview.metric.cacheSavings": "缓存节省",
	"overview.metric.cacheSavingsTitle": "相较于将相同提示词输入按未缓存计费所节省的成本；缓存写入可能使该值为负数",
	"overview.metric.cacheRateTitle": "由缓存提供的提示词输入：缓存读取 ÷（未缓存输入 + 缓存读取）",
	"overview.metric.errorRate": "错误率",
	"overview.metric.uncachedInput": "未缓存输入",
	"overview.metric.uncachedInputTitle": "对话中未从缓存提供的输入 Token",
	"overview.metric.cacheRead": "缓存读取",
	"overview.metric.cacheReadTitle": "从提示词缓存读取的对话输入 Token",
	"overview.metric.outputTokens": "输出 Token",
	"overview.metric.conversationTotal": "对话 Token 总量",
	"overview.metric.conversationTotalTitle": "未缓存输入 + 缓存读取 + 缓存写入 + 输出",
	"overview.metric.premiumRequests": "高级请求数",
	"overview.metric.tokensPerSecond": "Tokens/s",
	"overview.metric.avgLatency": "平均延迟",
	"overview.metric.avgTtft": "平均 TTFT",
	...
	"models.expanded.cacheSavings": "缓存节省",
	...
	"tools.table.column.avgDuration": "平均耗时",
	"tools.table.avgDurationTitle": "从 assistant 发出工具调用到工具结果返回的耗时",
	...
	"providers.totals.subtitle": "当前范围内各提供商的 Token、请求和成本汇总",
	"providers.totals.empty": "当前范围内暂无请求记录",
	"providers.totals.tokensTitle": "输入 {input} · 输出 {output} · 缓存读取 {cacheRead} · 缓存写入 {cacheWrite}",
	"providers.column.provider": "提供商",
	"providers.column.requests": "请求数",
	"providers.column.errorRate": "错误率",
	"providers.column.models": "模型数",
	"providers.column.tokens": "Tokens",
	"providers.column.share": "占比",
	"providers.column.cost": "成本",
	"providers.column.tps": "Tok/s",
	"providers.trend.title": "按提供商的消耗",
	"providers.trend.subtitle": "各提供商随时段堆叠的 Token/成本消耗",
	"providers.trend.metric.tokens": "Tokens",
	"providers.trend.metric.cost": "成本",
	"providers.trend.empty": "当前范围内暂无提供商活动",
	"providers.trend.footerTotal": "合计：{value}",
	"providers.peakHours.title": "峰值消耗时段",
	"providers.peakHours.subtitle": "按本地小时的 Token 消耗",
	"providers.peakHours.subtitlePeak": "按本地小时的 Token 消耗 - 峰值在 {time}",
	"providers.peakHours.ariaLabel": "提供商",
	"providers.peakHours.allProviders": "全部提供商",
	"providers.peakHours.empty": "当前范围内暂无活动",
	"providers.windows.title": "订阅窗口",
	"providers.windows.subtitle": "每个用量窗口的价值，以及峰值需求所需的账号数",
	"providers.windows.empty": "暂无用量快照记录 - 它们在获取用量时自动累积（TUI 底栏、/usage、omp usage）",
	"providers.windows.column.window": "窗口",
	"providers.windows.column.accounts": "账号数",
	"providers.windows.column.consumed": "已消耗窗口",
	"providers.windows.column.capacity": "估算 Tokens/窗口",
	"providers.windows.column.peak": "峰值利用率",
	"providers.windows.column.ideal": "理想账号数",
	"providers.windows.column.exhausted": "耗尽次数",
	"providers.windows.consumedTitle": "当前范围内消耗的订阅窗口等量（各账号用量份额增量之和）",
	"providers.windows.capacityTitle": "范围内提供商消耗的 Token ÷ 消耗窗口数 - 一个完整窗口的价值",
	"providers.windows.peakTitle": "任一采样时刻各账号用量份额之和的峰值",
	"providers.windows.idealTitle": "将峰值需求保持在总容量 90% 以下所需的账号数",
	"providers.windows.idealHave": "（已有 {n}）",
	"providers.utilization.title": "窗口利用率",
	"providers.utilization.subtitle": "各账号和窗口的最新利用率 - 红色为已耗尽，黄色超过 80%",
	"providers.utilization.ariaLabel": "提供商",
	"providers.utilization.empty": "暂无用量快照记录 - 它们在获取用量时自动累积",
	"providers.utilization.label.used": "已用",
	"providers.utilization.tooltip.used": "{value}% 已用",
	"providers.utilization.tooltip.recorded": "{used} · 记录于 {time}",
};
