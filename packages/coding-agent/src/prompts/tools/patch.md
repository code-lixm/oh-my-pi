...
- If edit fails or breaks structure, you MUST refresh affected current lines with `read`/`grep` and produce a new patch — you NEVER retry the same diff or rerun CodeGraph solely to refresh a snapshot
