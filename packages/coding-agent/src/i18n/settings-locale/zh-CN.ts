export const SETTINGS_ZH_CN_MESSAGES: Record<string, string> = {
	...
	"The selected job cannot be cancelled.": "无法取消选中的任务。",
	...
	"Enable persisted heartbeat prompts for the current session": "为当前会话启用持久化心跳提示",
	"Default Interval": "默认间隔",
	"Default interval used by /heartbeat when no interval is specified": "/heartbeat 未指定间隔时使用的默认值",
	"Delivery Mode": "投递模式",
	"Default delivery mode used by /heartbeat": "/heartbeat 使用的默认投递模式",
	steer: "立即引导",
	follow_up: "排队跟进",
	Schedule: "调度",
	...
	"Heartbeat scheduling is unavailable in this session.": "当前会话无法使用心跳调度。",
	"Heartbeat scheduled: {job}": "已创建心跳：{job}",
	"No heartbeat is configured.": "尚未配置心跳。",
	...
	"Usage: /heartbeats [list]": "用法：/heartbeats [list]",
	"No heartbeats are configured.": "尚未配置心跳。",
	...
	"Manage persisted heartbeat prompts for the current session": "管理当前会话的持久化心跳提示",
	"Show the current heartbeat": "显示当前心跳",
	"Pause the current heartbeat": "暂停当前心跳",
	"Resume the current heartbeat": "恢复当前心跳",
	"Remove the current heartbeat": "移除当前心跳",
	"List persisted heartbeat prompts for the current session": "列出当前会话的持久化心跳提示",
	"List user and RLM heartbeats": "列出用户与 RLM 心跳",
