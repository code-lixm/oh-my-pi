export const SETTINGS_EN_MESSAGES: Record<string, string> = {
	...
	"Theme preview failed": "Theme preview failed",
	...
	"Choose a model from the {provider} provider. {selected}/{total} selected.":
		"Choose a model from the {provider} provider. {selected}/{total} selected.",
	"Choose another provider or press Esc to continue.": "Choose another provider or press Esc to continue.",
	...
	"Sign in and pick a web search provider. Press Esc when you're done.":
		"Sign in and pick a web search provider. Press Esc when you're done.",
	"Signing in to {provider}": "Signing in to {provider}",
	"Signed in to {provider}": "Signed in to {provider}",
	"{count} ctx": "{count} ctx",
	"{count} out": "{count} out",
	...
	'Failed to load theme "{value}": {error}\\nFell back to dark theme.':
		'Failed to load theme "{value}": {error}\\nFell back to dark theme.',
	"Failed to load themes: {message}": "Failed to load themes: {message}",
	...
	"Fallback ({role}): {from} -> {to}": "Fallback ({role}): {from} -> {to}",
	"Fallback ({role}) succeeded on {model}": "Fallback ({role}) succeeded on {model}",
	"Primary endpoint ({role}) recovered: {from} -> {to}": "Primary endpoint ({role}) recovered: {from} -> {to}",
	...
	"Login failed: {message}": "Login failed: {message}",
	...
	"(active)": "(active)",
	"(cancelled)": "(cancelled)",
	"(clipboard copy attempted; Alt+C retries)": "(clipboard copy attempted; Alt+C retries)",
	...
	Detail: "Detail",
	"lines {start}-{end} of {total}": "lines {start}-{end} of {total}",
	"Recent tools": "Recent tools",
	"The selected job has no focusable agent.": "The selected job has no focusable agent.",
	"The selected job cannot be cancelled.": "The selected job cannot be cancelled.",
	"Cancellation requested.": "Cancellation requested.",
	"The selected job is no longer running.": "The selected job is no longer running.",
	Work: "Work",
	Intent: "Intent",
	...
	"{count} earlier jobs": "{count} earlier jobs",
	"{count} later jobs": "{count} later jobs",
	Activity: "Activity",
	Status: "Status",
	Progress: "Progress",
	Duration: "Duration",
	"Dynamic summary": "Dynamic summary",
	"Waiting for Main": "Waiting for Main",
	"Task result": "Task result",
	"Report status": "Report status",
	"Delivery pending": "Delivery pending",
	"Delivering to Main": "Delivering to Main",
	"Delivered to Main": "Delivered to Main",
	"Main unavailable": "Main unavailable",
	previous: "previous",
	next: "next",
	"Running tasks": "Running tasks",
	"Needs attention": "Needs attention",
	"Parked agents": "Parked agents",
	...
	"Idle: {note}": "Idle: {note}",
	"Queued: waiting for runnable slot": "Queued: waiting for runnable slot",
	...
	"Browsing all themes · Esc returns to curated choices": "Browsing all themes · Esc returns to curated choices",
	Bundled: "Bundled",
	"Cancelled.": "Cancelled.",
	...
	"Esc skips this step": "Esc skips this step",
	...
	"Handing off to the normal CLI…": "Handing off to the normal CLI…",
	...
	"Node:": "Node:",
	None: "None",
	"Not configured yet — add its API key or sign in to enable it.":
		"Not configured yet — add its API key or sign in to enable it.",
	...
	"Tip: You can complete pairing with /login <redirect URL>.":
		"Tip: You can complete pairing with /login <redirect URL>.",
	Tips: "Tips",
	"Titanium in dark terminals, Light in light terminals": "Titanium in dark terminals, Light in light terminals",
	Titanium: "Titanium",
	...
	"enter send · shift+enter newline · / commands": "enter send · shift+enter newline · / commands",
	...
	"Ask anything, edit files, run tools": "Ask anything, edit files, run tools",
	...
	"Automatically resume the most recent session in the current directory":
		"Automatically resume the most recent session in the current directory",
	"Automatically uses the first configured provider.": "Automatically uses the first configured provider.",
	...
	"Setup step {current} of {total}": "Setup step {current} of {total}",
	...
	"Show every built-in and custom theme": "Show every built-in and custom theme",
	...
	"Web search": "Web search",
	"Web search set to {label}": "Web search set to {label}",
	...
	ASCII: "ASCII",
	"ASCII glyphs with the dark terminal theme": "ASCII glyphs with the dark terminal theme",
	Unicode: "Unicode",
	Low: "Low",
	Lynx: "Lynx",
	Medium: "Medium",
	...
	"j/k:select · {enterAction} · Esc/←←:close": "j/k:select · {enterAction} · Esc/←←:close",
	"f:focus": "f:focus",
	"m:message": "m:message",
	"p:Main": "p:Main",
	"r:revive": "r:revive",
	...
	"Not started: pending prompt": "Not started: pending prompt",
	Running: "Running",
	...
	"Pick + download the speech-to-text and text-to-speech models and an audio recorder":
		"Pick + download the speech-to-text and text-to-speech models and an audio recorder",
	"Pick the row that renders cleanly in your terminal.": "Pick the row that renders cleanly in your terminal.",
	"Pick a theme": "Pick a theme",
	"Pick a provider to sign in — you can connect more than one.":
		"Pick a provider to sign in — you can connect more than one.",
	...
	"Set up speech (pick STT + TTS models, install a recorder)":
		"Set up speech (pick STT + TTS models, install a recorder)",
	"Set up your providers": "Set up your providers",
	...
	"Browser login: {link} {hint}": "Browser login: {link} {hint}",
	...
	"Paste the returned code or redirect URL when prompted.": "Paste the returned code or redirect URL when prompted.",
	...
	"Adjust red/green contrast": "Adjust red/green contrast",
	"agent default": "agent default",
	...
	"Toggle goal mode (persistent autonomous objective for this session)":
		"Toggle goal mode (persistent autonomous objective for this session)",
	"Set or replace the goal": "Set or replace the goal",
	"Show current goal details": "Show current goal details",
	"Pause the current goal": "Pause the current goal",
	"Resume a paused goal": "Resume a paused goal",
	"Drop the current goal": "Drop the current goal",
	"Adjust the token budget": "Adjust the token budget",
	"Interview and refine a goal before enabling goal mode": "Interview and refine a goal before enabling goal mode",
	"Toggle loop mode. While enabled, the next prompt you send re-submits after every yield. Esc cancels the current iteration; /loop again to disable.":
		"Toggle loop mode. While enabled, the next prompt you send re-submits after every yield. Esc cancels the current iteration; /loop again to disable.",
	"Queue a message for after the agent yields": "Queue a message for after the agent yields",
	"Switch model for this session": "Switch model for this session",
	"Show current model selection": "Show current model selection",
	"Switch model for this session (same as alt+p)": "Switch model for this session (same as alt+p)",
	...
	"Disable fast mode": "Disable fast mode",
	"Show fast mode status": "Show fast mode status",
	"Switch to a fast/cheap model at the next action (works even without --prewalk)":
		"Switch to a fast/cheap model at the next action (works even without --prewalk)",
	"Prewalk at the next action": "Prewalk at the next action",
	"Toggle the advisor (a second model that reviews each turn and injects notes)":
		"Toggle the advisor (a second model that reviews each turn and injects notes)",
	"Toggle advisor": "Toggle advisor",
	"Enable the advisor": "Enable the advisor",
	"Disable the advisor": "Disable the advisor",
	"Show advisor status": "Show advisor status",
	"Copy the advisor's transcript to clipboard": "Copy the advisor's transcript to clipboard",
	"Open the advisor configuration editor (TUI)": "Open the advisor configuration editor (TUI)",
	"Export session to HTML file": "Export session to HTML file",
	...
	"Share session via an encrypted link (share server or secret gist)":
		"Share session via an encrypted link (share server or secret gist)",
	"Share this session live via a relay": "Share this session live via a relay",
	"Share a read-only link (guests can watch, not prompt)": "Share a read-only link (guests can watch, not prompt)",
	"Show link + participants": "Show link + participants",
	"Stop sharing": "Stop sharing",
	"Join a shared collab session": "Join a shared collab session",
	"Leave the collab session": "Leave the collab session",
	"Toggle browser headless vs visible mode": "Toggle browser headless vs visible mode",
	"Switch to headless mode": "Switch to headless mode",
	"Switch to visible mode": "Switch to visible mode",
	"Pick text or code from the conversation to copy": "Pick text or code from the conversation to copy",
	"View or modify the agent's todo list": "View or modify the agent's todo list",
	"Manage todos": "Manage todos",
	"Open todos in $EDITOR (Markdown round-trip)": "Open todos in $EDITOR (Markdown round-trip)",
	"Copy todos as Markdown to clipboard": "Copy todos as Markdown to clipboard",
	"Write todos as Markdown to a file (default: TODO.md)": "Write todos as Markdown to a file (default: TODO.md)",
	"Replace todos from a Markdown file (default: TODO.md)": "Replace todos from a Markdown file (default: TODO.md)",
	"Append a task; phase fuzzy-matched or auto-created": "Append a task; phase fuzzy-matched or auto-created",
	"Mark task in_progress (fuzzy-matched)": "Mark task in_progress (fuzzy-matched)",
	"Mark task/phase/all completed (fuzzy-matched)": "Mark task/phase/all completed (fuzzy-matched)",
	"Mark task/phase/all abandoned (fuzzy-matched)": "Mark task/phase/all abandoned (fuzzy-matched)",
	"Remove task/phase/all (fuzzy-matched)": "Remove task/phase/all (fuzzy-matched)",
	"Session management commands": "Session management commands",
	"Show session information": "Show session information",
	"Show session info and stats": "Show session info and stats",
	"Delete current session and return to selector": "Delete current session and return to selector",
	"Show async background jobs status": "Show async background jobs status",
	...
	"Show complete changelog": "Show complete changelog",
	"Show all keyboard shortcuts": "Show all keyboard shortcuts",
	"Show tools currently visible to the agent": "Show tools currently visible to the agent",
	"Show available tools": "Show available tools",
	"Show estimated context usage breakdown": "Show estimated context usage breakdown",
	"Show context usage": "Show context usage",
	"Open Extension Control Center dashboard": "Open Extension Control Center dashboard",
	"Open Agent Control Center dashboard": "Open Agent Control Center dashboard",
	"Create a new branch from a previous message": "Create a new branch from a previous message",
	"Create a new fork from a previous message": "Create a new fork from a previous message",
	"Navigate session tree (switch branches)": "Navigate session tree (switch branches)",
	"Login with OAuth provider": "Login with OAuth provider",
	"Logout from OAuth provider": "Logout from OAuth provider",
	"Manage MCP servers (add, list, remove, test)": "Manage MCP servers (add, list, remove, test)",
	"Manage MCP servers": "Manage MCP servers",
	"Add a new MCP server": "Add a new MCP server",
	"List all configured MCP servers": "List all configured MCP servers",
	"Remove an MCP server": "Remove an MCP server",
	"Test connection to a server": "Test connection to a server",
	"Reauthorize OAuth for a server": "Reauthorize OAuth for a server",
	"Remove OAuth auth from a server": "Remove OAuth auth from a server",
	"Enable an MCP server": "Enable an MCP server",
	"Disable an MCP server": "Disable an MCP server",
	"Search Smithery registry and deploy an MCP server": "Search Smithery registry and deploy an MCP server",
	"Login to Smithery and cache API key": "Login to Smithery and cache API key",
	"Remove cached Smithery API key": "Remove cached Smithery API key",
	"Reconnect to a specific MCP server": "Reconnect to a specific MCP server",
	"Force reload MCP runtime tools": "Force reload MCP runtime tools",
	"List available resources from connected servers": "List available resources from connected servers",
	"List available prompts from connected servers": "List available prompts from connected servers",
	"Show notification capabilities and subscriptions": "Show notification capabilities and subscriptions",
	"Show help message": "Show help message",
	"Manage SSH hosts (add, list, remove)": "Manage SSH hosts (add, list, remove)",
	"Manage SSH connections": "Manage SSH connections",
	"Add an SSH host": "Add an SSH host",
	"List all configured SSH hosts": "List all configured SSH hosts",
	"Remove an SSH host": "Remove an SSH host",
	"Start a new session": "Start a new session",
	"Reset provider stream state without changing the local transcript":
		"Reset provider stream state without changing the local transcript",
	"Delete the current session and start a new one": "Delete the current session and start a new one",
	"Manually compact the session context": "Manually compact the session context",
	"Compact the conversation": "Compact the conversation",
	"Drop heavy content from context (tool results, large blocks)":
		"Drop heavy content from context (tool results, large blocks)",
	"Shake heavy content out of the conversation context": "Shake heavy content out of the conversation context",
	"Strip tool results + large blocks (default)": "Strip tool results + large blocks (default)",
	"Strip image blocks": "Strip image blocks",
	"Hand off session context to a new session": "Hand off session context to a new session",
	"Resume a different session": "Resume a different session",
	"Ask an ephemeral side question using the current session context":
		"Ask an ephemeral side question using the current session context",
	"Run a full background agent on tangential work": "Run a full background agent on tangential work",
	"Forge a TTSR rule from a complaint to stop a recurring behavior":
		"Forge a TTSR rule from a complaint to stop a recurring behavior",
	"Retry the last failed agent turn": "Retry the last failed agent turn",
	"Open debug tools selector": "Open debug tools selector",
	"Inspect and operate memory maintenance": "Inspect and operate memory maintenance",
	"Manage memory": "Manage memory",
	"Show current memory injection payload": "Show current memory injection payload",
	"Show memory backend statistics": "Show memory backend statistics",
	"Run memory backend diagnostics": "Run memory backend diagnostics",
	"Clear persisted memory data and artifacts": "Clear persisted memory data and artifacts",
	"Alias for clear": "Alias for clear",
	"Enqueue memory consolidation maintenance": "Enqueue memory consolidation maintenance",
	"Alias for enqueue": "Alias for enqueue",
	"List mental models on the active bank": "List mental models on the active bank",
	"Show one mental model (id required)": "Show one mental model (id required)",
	"Refresh auto-refresh models bank-wide, or one model by id":
		"Refresh auto-refresh models bank-wide, or one model by id",
	"Diff the change history of a mental model": "Diff the change history of a mental model",
	"Create any built-in mental models that are missing": "Create any built-in mental models that are missing",
	"Delete a mental model from the bank (id required)": "Delete a mental model from the bank (id required)",
	"Re-pull the cached <mental_models> block": "Re-pull the cached <mental_models> block",
	"Rename the current session": "Rename the current session",
	"Move the current session to a different directory": "Move the current session to a different directory",
	"Exit the application": "Exit the application",
	"Manage marketplace plugin sources and installed plugins": "Manage marketplace plugin sources and installed plugins",
	"Manage plugins from marketplaces": "Manage plugins from marketplaces",
	"Add a marketplace source": "Add a marketplace source",
	"Remove a marketplace source": "Remove a marketplace source",
	"Update marketplace catalog(s)": "Update marketplace catalog(s)",
	"List configured marketplaces": "List configured marketplaces",
	"Browse available plugins": "Browse available plugins",
	"Install a plugin (interactive browser if no args)": "Install a plugin (interactive browser if no args)",
	"Uninstall a plugin (selector if no args)": "Uninstall a plugin (selector if no args)",
	"List installed marketplace plugins": "List installed marketplace plugins",
	"Upgrade outdated plugins": "Upgrade outdated plugins",
	"Show usage guide": "Show usage guide",
	"View and manage installed plugins": "View and manage installed plugins",
	"Manage plugins": "Manage plugins",
	"List all installed plugins (npm + marketplace)": "List all installed plugins (npm + marketplace)",
	"Enable a marketplace plugin": "Enable a marketplace plugin",
	"Disable a marketplace plugin": "Disable a marketplace plugin",
	"Reload all plugins (skills, commands, hooks, tools, agents, MCP)":
		"Reload all plugins (skills, commands, hooks, tools, agents, MCP)",
	"Reload all plugins": "Reload all plugins",
	"Force next turn to use a specific tool": "Force next turn to use a specific tool",
	"Freeze all agents (main, subagents, advisor) until resumed":
		"Freeze all agents (main, subagents, advisor) until resumed",
	"Quit the application": "Quit the application",
	// Inline / acp input hints
	"[prompt]": "[prompt]",
	...
	"<complaint>": "<complaint>",
	"[name@marketplace]": "[name@marketplace]",
	// (removed duplicate "<title>" key — identical to earlier definition)
	// (kept untranslated: shell-style option syntax)
	...
	"Plan: disabled in settings": "Plan: disabled in settings",
	"Plan: blocked by goal mode": "Plan: blocked by goal mode",
	"Plan review: available": "Plan review: available",
	"Plan review: plan mode inactive": "Plan review: plan mode inactive",
	"Plan: on": "Plan: on",
	"Plan: on ({file})": "Plan: on ({file})",
	"Plan: off": "Plan: off",
	"Vibe: on": "Vibe: on",
	"Vibe: off": "Vibe: off",
	"Vibe: blocked by plan mode": "Vibe: blocked by plan mode",
	"Vibe: blocked by goal mode": "Vibe: blocked by goal mode",
	"Goal: disabled in settings": "Goal: disabled in settings",
	"Goal: off": "Goal: off",
	"Goal: blocked by plan mode": "Goal: blocked by plan mode",
	"Goal: {status} ({detail})": "Goal: {status} ({detail})",
	"Loop: off": "Loop: off",
	"Loop: paused": "Loop: paused",
	"Loop: on ({detail})": "Loop: on ({detail})",
	"Loop: on (repeating prompt)": "Loop: on (repeating prompt)",
	"Loop: on (waiting for next prompt)": "Loop: on (waiting for next prompt)",
	"Model: {provider}/{id}": "Model: {provider}/{id}",
	"Model: none selected": "Model: none selected",
	"Fast: {status}": "Fast: {status}",
	"Advisor: on ({n} advisors)": "Advisor: on ({n} advisors)",
	"Advisor: on ({provider}/{id})": "Advisor: on ({provider}/{id})",
	"Advisor: configured, no model": "Advisor: configured, no model",
	"Advisor: off": "Advisor: off",
	"Collab: hosting ({n} guests)": "Collab: hosting ({n} guests)",
	"Collab: guest": "Collab: guest",
	"Collab: read-only guest": "Collab: read-only guest",
	"Collab: off": "Collab: off",
	"Leave collab: hosting": "Leave collab: hosting",
	"Leave collab: guest": "Leave collab: guest",
	"Leave collab: not in collab": "Leave collab: not in collab",
	"Browser: disabled": "Browser: disabled",
	"Browser: headless": "Browser: headless",
	"Browser: visible": "Browser: visible",
	"Todos: none": "Todos: none",
	"Todos: {open} open ({inProgress} in progress, {completed} done)":
		"Todos: {open} open ({inProgress} in progress, {completed} done)",
	"Jobs: none": "Jobs: none",
	"Jobs: {running} running, {recent} recent": "Jobs: {running} running, {recent} recent",
	"Tools: none available": "Tools: none available",
	"Tools: {active} active / {all} available": "Tools: {active} active / {all} available",
	"Context: unavailable": "Context: unavailable",
	"Context: {percent}% ({tokens}/{contextWindow})": "Context: {percent}% ({tokens}/{contextWindow})",
	"Login: choose provider": "Login: choose provider",
	"Login: waiting for {provider} callback": "Login: waiting for {provider} callback",
	"Fresh: unavailable while streaming": "Fresh: unavailable while streaming",
	"Fresh: ready": "Fresh: ready",
	"Compact: context {percent}% used": "Compact: context {percent}% used",
	...
	"Probe the primary and restore it at a safe boundary once healthy":
		"Probe the primary and restore it at a safe boundary once healthy",
	"Cooldown expiry": "Cooldown expiry",
	...
	steer: "steer",
	follow_up: "follow_up",
	"Default delivery mode used by /schedule": "Default delivery mode used by /schedule",
	Autonomous: "Autonomous",
	"Enable Autonomous Mode": "Enable Autonomous Mode",
	"Enable automatic continuation without waiting for user input":
		"Enable automatic continuation without waiting for user input",
	"Max Continuations": "Max Continuations",
	"Maximum automatic continuations after a turn completes": "Maximum automatic continuations after a turn completes",
	"Max Turns": "Max Turns",
	"Maximum turns in one autonomous run": "Maximum turns in one autonomous run",
	"Max Tokens": "Max Tokens",
	"Maximum tokens available to one autonomous run": "Maximum tokens available to one autonomous run",
	"Timeout (ms)": "Timeout (ms)",
	"Maximum duration in milliseconds for one autonomous run": "Maximum duration in milliseconds for one autonomous run",
	"Gate Commands": "Gate Commands",
	"Commands that must succeed before autonomous work can continue":
		"Commands that must succeed before autonomous work can continue",
	"Gate Max Retries": "Gate Max Retries",
	"Maximum retries for each autonomous gate command": "Maximum retries for each autonomous gate command",
	"Gate Timeout (ms)": "Gate Timeout (ms)",
	"Maximum duration in milliseconds for each autonomous gate command":
		"Maximum duration in milliseconds for each autonomous gate command",
	Refinement: "Refinement",
	"Enable /refine": "Enable /refine",
	"Enable /refine and continual harness updates": "Enable /refine and continual harness updates",
	"Auto Refine Turns": "Auto Refine Turns",
	"Run refinement automatically after this many turns": "Run refinement automatically after this many turns",
	"Auto Refine Cooldown (ms)": "Auto Refine Cooldown (ms)",
	"Minimum milliseconds between automatic refinements": "Minimum milliseconds between automatic refinements",
	"Python Skills": "Python Skills",
	"Enable Python Skills": "Enable Python Skills",
	"Enable bundled Python skills": "Enable bundled Python skills",
	"Trust Mode": "Trust Mode",
	"Choose whether Python skills require confirmation before running":
		"Choose whether Python skills require confirmation before running",
	RLM: "RLM",
	"RLM Max Depth": "RLM Max Depth",
	...
	"Next run: {nextRunAt}": "Next run: {nextRunAt}",
	"Schedule not found: {id}": "Schedule not found: {id}",
	...
	"Usage: /schedule {verb} <id>": "Usage: /schedule {verb} <id>",
	"Usage: /schedule update <id> <schedule> -- <prompt>": "Usage: /schedule update <id> <schedule> -- <prompt>",
	"Scheduled prompt updated: {job}": "Scheduled prompt updated: {job}",
	"Usage: /schedule <add|list|pause|resume|cancel|update> ...":
		"Usage: /schedule <add|list|pause|resume|cancel|update> ...",
	"Continual harness is disabled. Enable refinement.enabled first.":
		"Continual harness is disabled. Enable refinement.enabled first.",
	"Usage: /refine status": "Usage: /refine status",
	"{kind}={count}": "{kind}={count}",
	"{id}: {scope}: {summary}": "{id}: {scope}: {summary}",
	"Continual harness: {counts}": "Continual harness: {counts}",
	"Recent refinements:": "Recent refinements:",
	"Usage: /refine rollback <result-id> [--local|--global]": "Usage: /refine rollback <result-id> [--local|--global]",
	...
	"Autonomous mode is {status}.": "Autonomous mode is {status}.",
	"Timeout: {timeoutMs}ms; gates: {gates}.": "Timeout: {timeoutMs}ms; gates: {gates}.",
	"Autonomous mode is not available yet. It will be enabled after integration wiring.":
		"Autonomous mode is not available yet. It will be enabled after integration wiring.",
	"Autonomous mode enabled with quality gate: {command}.": "Autonomous mode enabled with quality gate: {command}.",
	"Autonomous mode enabled.": "Autonomous mode enabled.",
	"Autonomous mode disabled.": "Autonomous mode disabled.",
	"Autonomous quality gates cleared.": "Autonomous quality gates cleared.",
	"Usage: /autonomous gate add <command>": "Usage: /autonomous gate add <command>",
	"Autonomous quality gate added: {command}.": "Autonomous quality gate added: {command}.",
	"Usage: /autonomous budget <continuations|turns|tokens|time> <positive integer>":
		"Usage: /autonomous budget <continuations|turns|tokens|time> <positive integer>",
	"Autonomous {budgetType} budget set to {value}.": "Autonomous {budgetType} budget set to {value}.",
	"Usage: /autonomous [on [gate-command]|off|status|gate add <command>|gate clear|budget <continuations|turns|tokens|time> <n>]":
		"Usage: /autonomous [on [gate-command]|off|status|gate add <command>|gate clear|budget <continuations|turns|tokens|time> <n>]",
	"Unable to configure autonomous mode: {error}": "Unable to configure autonomous mode: {error}",
	"Autonomous: unavailable": "Autonomous: unavailable",
	"Autonomous: {status}": "Autonomous: {status}",
	"Install Python skill {name}?": "Install Python skill {name}?",
	...
	"No declared third-party dependencies": "No declared third-party dependencies",
	...
	"List scheduled prompts": "List scheduled prompts",
	"Pause a schedule": "Pause a schedule",
	"Resume a schedule": "Resume a schedule",
	"Cancel a schedule": "Cancel a schedule",
	"Update a schedule": "Update a schedule",
	"Control host-owned autonomous continuation and quality gates":
		"Control host-owned autonomous continuation and quality gates",
	"Control autonomous continuation": "Control autonomous continuation",
	"Enable autonomous continuation": "Enable autonomous continuation",
	"Disable autonomous continuation": "Disable autonomous continuation",
	"Show autonomous budgets and gate status": "Show autonomous budgets and gate status",
