...
import validationRequestPromptZh from "../../prompts/security/validate-request.zh-CN.md" with { type: "text" };
	...
	try {
		switch (verb || "scans") {
			...
			case "validate": {
				...
				return {
					prompt: prompt
						.render(selectPrompt(validationRequestPrompt, validationRequestPromptZh), {
