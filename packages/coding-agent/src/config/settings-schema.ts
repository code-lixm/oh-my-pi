...
export const SETTINGS_SCHEMA = {
	...
	"features.unexpectedStopDetection": {
		...
		ui: {
			...
			label: tSettingsUi("Unexpected Stops"),
			description: tSettingsUi(
			...
			options: [
				{ value: "none", label: tSettingsUi("None"), description: tSettingsUi("Disabled") },
				{
					value: "mechanical",
					label: tSettingsUi("Mechanical"),
					description: tSettingsUi("Retry stops with no visible assistant message; tool calls are excluded (default)"),
				},
				{
					value: "smart",
					label: tSettingsUi("Smart"),
					description: tSettingsUi("Mechanical + small-model classification of text-only stops"),
				},
			],
		},
	},
