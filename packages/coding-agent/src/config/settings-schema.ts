	...
	"providers.image": {
		...
		ui: {
			...
			options: [
				...
				{ value: "gemini", label: tSettingsUi("Gemini"), description: tSettingsUi("Requires GEMINI_API_KEY") },
				{
					value: "openrouter",
					label: tSettingsUi("OpenRouter"),
					description: tSettingsUi("Requires OPENROUTER_API_KEY"),
				},
			],
		},
	},
