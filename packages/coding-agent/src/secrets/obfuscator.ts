...
// Preserve the pre-split public deep-path surface. These symbols moved into
// domain modules, but `./secrets/*` still exposes `obfuscator.ts` to extensions.
export {
...
export { regexHasUnresolvableShortMatchFallback } from "./replacement";
