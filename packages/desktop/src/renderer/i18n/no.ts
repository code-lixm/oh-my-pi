export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OMP er lastet ned. Vil du installere den og starte på nytt?",
