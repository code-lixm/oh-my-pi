export const dict = {
  ...
  "desktop.updater.none.message": "OMP'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "OMP'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
