export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "OMP versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
