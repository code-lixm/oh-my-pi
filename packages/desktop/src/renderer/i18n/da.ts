export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OMP er blevet downloadet. Vil du installere den og genstarte?",
