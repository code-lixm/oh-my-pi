export const dict = {
  ...
  "desktop.updater.none.message": "Már az OMP legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az OMP {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
