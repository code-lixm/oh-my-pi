export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse OMP uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "OMP'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
