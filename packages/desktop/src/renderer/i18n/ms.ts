export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} OMP telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
