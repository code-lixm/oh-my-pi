export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van OMP is gedownload. Wil je deze installeren en OMP opnieuw starten?",
