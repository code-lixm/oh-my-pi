export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Έχει γίνει λήψη της έκδοσης {{version}} του OMP. Θέλετε να την εγκαταστήσετε και να επανεκκινήσετε την εφαρμογή;",
