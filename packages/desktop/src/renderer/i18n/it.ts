export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di OMP è stata scaricata. Vuoi installarla e riavviare l'app?",
