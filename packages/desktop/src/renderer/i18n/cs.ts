export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace OMP. Chcete ji nainstalovat a aplikaci znovu spustit?",
