export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OMP-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OMP-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
