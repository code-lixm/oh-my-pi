export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OMP wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
