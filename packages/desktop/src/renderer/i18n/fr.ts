export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OMP a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
