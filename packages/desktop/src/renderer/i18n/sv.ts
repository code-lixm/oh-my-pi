export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av OMP har laddats ned. Vill du installera den och starta om programmet?",
