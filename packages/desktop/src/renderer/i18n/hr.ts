export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije OMP. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
