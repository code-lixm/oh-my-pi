export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të OMP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i OMP është shkarkuar, dëshironi ta instaloni dhe rinisni?",
