export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av OMP.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av OMP er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
