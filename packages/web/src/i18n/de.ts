...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OMP",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OMP zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in OMP zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OMP zu nutzen.",
  ...
  "prompt.omp.thinking.title": "Denkaufwand",
  "prompt.omp.thinking.off": "Denken: Aus",
  "prompt.omp.thinking.auto": "Denken: Automatisch",
  "prompt.omp.thinking.minimal": "Denken: Minimal",
  "prompt.omp.thinking.low": "Denken: Niedrig",
  "prompt.omp.thinking.medium": "Denken: Mittel",
  "prompt.omp.thinking.high": "Denken: Hoch",
  "prompt.omp.thinking.xhigh": "Denken: Sehr hoch",
  "prompt.omp.thinking.max": "Denken: Maximal",
  "prompt.omp.advisor.title": "Berater",
  "prompt.omp.advisor.on": "Berater: Ein",
  "prompt.omp.advisor.off": "Berater: Aus",
  "prompt.omp.approval.title": "Werkzeugfreigabe",
  "prompt.omp.approval.alwaysAsk": "Freigabe: Fragen",
  "prompt.omp.approval.write": "Freigabe: Schreiben",
  "prompt.omp.approval.yolo": "Freigabe: YOLO",
  ...
  "dialog.server.description": "Wechseln Sie den OMP-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von OMP ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Namen des konfigurierten Anbieters und Modells.",
  "error.chain.mcpFailed":
    "MCP-Server „{{name}}“ ist fehlgeschlagen.",
  ...
  "home.providerTip":
    "OMP mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Öffnen Sie ein Projekt, um zu beginnen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OMP ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OMP auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OMP dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OMP anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OMP automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "OMP ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von OMP wird verwendet.",
  ...
  "settings.metadata.scope.user": "Benutzer",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Nativ",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Marktplatz",
  ...
  "desktop.recovery.loadFailed": "OMP konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OMP-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "OMP reagiert nicht",
  ...
  "help.tabs.date": "Funktionsübersicht",
  "help.tabs.introduction": "Tabs organisieren Arbeitsbereiche und aktive Sitzungen.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Ein Worktree ist ein separates Arbeitsverzeichnis für ein Projekt.",
