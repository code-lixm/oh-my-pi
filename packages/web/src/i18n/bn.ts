...
export const dict: Record<string, string> = {
  ...
  "desktop.recovery.loadFailed": "OMP লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "OMP উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "OMP সাড়া দিচ্ছে না",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি OMP দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং OMP-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি OMP-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি OMP-এ ব্যবহার করুন৷",
  ...
  "prompt.omp.thinking.title": "যুক্তির মাত্রা",
  "prompt.omp.thinking.off": "যুক্তি: বন্ধ",
  "prompt.omp.thinking.auto": "যুক্তি: স্বয়ংক্রিয়",
  "prompt.omp.thinking.minimal": "যুক্তি: সর্বনিম্ন",
  "prompt.omp.thinking.low": "যুক্তি: কম",
  "prompt.omp.thinking.medium": "যুক্তি: মাঝারি",
  "prompt.omp.thinking.high": "যুক্তি: উচ্চ",
  "prompt.omp.thinking.xhigh": "যুক্তি: অত্যন্ত উচ্চ",
  "prompt.omp.thinking.max": "যুক্তি: সর্বোচ্চ",
  "prompt.omp.advisor.title": "পরামর্শদাতা",
  "prompt.omp.advisor.on": "পরামর্শদাতা: চালু",
  "prompt.omp.advisor.off": "পরামর্শদাতা: বন্ধ",
  "prompt.omp.approval.title": "সরঞ্জাম অনুমোদন",
  "prompt.omp.approval.alwaysAsk": "অনুমোদন: জিজ্ঞাসা করুন",
  "prompt.omp.approval.write": "অনুমোদন: লিখুন",
  "prompt.omp.approval.yolo": "অনুমোদন: YOLO",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন OMP সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "help.tabs.date": "ফিচার overview",
  "help.tabs.introduction": "ট্যাবগুলো কাজ এবং সক্রিয় সেশনগুলোকে সাজায়।",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree হলো কোনো project-এর জন্য একটি আলাদা working directory।",
  ...
  "toast.update.description": "OMP ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.chain.checkConfig": "কনফিগার করা provider এবং model-এর নাম পরীক্ষা করুন।",
  "error.chain.mcpFailed":
    "MCP সার্ভার \"{{name}}\" ব্যর্থ হয়েছে।",
  ...
  "sidebar.gettingStarted.line1": "শুরু করতে একটি project খুলুন।",
  ...
  "settings.general.row.language.description": "OMP-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে OMP কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "OMP সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে OMP থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "OMP চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি OMP এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
  ...
  "settings.metadata.scope.user": "ব্যবহারকারী",
  "settings.metadata.scope.project": "প্রকল্প",
  "settings.metadata.scope.native": "স্থানীয়",
  "settings.metadata.scope.global": "সর্বজনীন",
  "settings.metadata.pluginKind.marketplace": "বাজার",
