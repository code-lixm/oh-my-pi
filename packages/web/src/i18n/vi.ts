...
export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu OMP",
  ...
  "desktop.recovery.loadFailed": "Không tải được OMP",
  "desktop.recovery.terminated": "Cửa sổ OMP đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "OMP không phản hồi",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do OMP cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong OMP.",
  ...
  "prompt.omp.thinking.title": "Mức độ suy nghĩ",
  "prompt.omp.thinking.off": "Suy nghĩ: Tắt",
  "prompt.omp.thinking.auto": "Suy nghĩ: Tự động",
  "prompt.omp.thinking.minimal": "Suy nghĩ: Tối thiểu",
  "prompt.omp.thinking.low": "Suy nghĩ: Thấp",
  "prompt.omp.thinking.medium": "Suy nghĩ: Trung bình",
  "prompt.omp.thinking.high": "Suy nghĩ: Cao",
  "prompt.omp.thinking.xhigh": "Suy nghĩ: Rất cao",
  "prompt.omp.thinking.max": "Suy nghĩ: Tối đa",
  "prompt.omp.advisor.title": "Cố vấn",
  "prompt.omp.advisor.on": "Cố vấn: Bật",
  "prompt.omp.advisor.off": "Cố vấn: Tắt",
  "prompt.omp.approval.title": "Phê duyệt công cụ",
  "prompt.omp.approval.alwaysAsk": "Phê duyệt: Luôn hỏi",
  "prompt.omp.approval.write": "Phê duyệt: Ghi",
  "prompt.omp.approval.yolo": "Phê duyệt: YOLO",
  ...
  "dialog.server.description": "Chuyển máy chủ OMP mà ứng dụng này kết nối tới.",
  ...
  "help.tabs.date": "Tổng quan về tính năng",
  "help.tabs.introduction": "Các thẻ sắp xếp công việc và các phiên đang hoạt động.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree là một thư mục làm việc riêng biệt cho một dự án.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của OMP ({{version}}) để cài đặt.",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp và mô hình đã cấu hình.",
  "error.chain.mcpFailed": "Máy chủ MCP \"{{name}}\" đã gặp lỗi.",
  ...
  "sidebar.gettingStarted.line1": "Mở một dự án để bắt đầu.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho OMP",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của OMP trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem OMP tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của OMP.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi OMP khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của OMP.",
  ...
  "settings.metadata.scope.user": "Người dùng",
  "settings.metadata.scope.project": "Dự án",
  "settings.metadata.scope.native": "Bản địa",
  "settings.metadata.scope.global": "Toàn cục",
  "settings.metadata.pluginKind.marketplace": "Chợ tiện ích",
