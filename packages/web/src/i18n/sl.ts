...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "OMP ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno OMP se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "OMP se ne odziva",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja OMP",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v OMP.",
  ...
  "prompt.omp.thinking.title": "Razmišljanje",
  "prompt.omp.thinking.off": "Izklopljeno",
  "prompt.omp.thinking.auto": "Samodejno",
  "prompt.omp.thinking.minimal": "Minimalno",
  "prompt.omp.thinking.low": "Nizko",
  "prompt.omp.thinking.medium": "Srednje",
  "prompt.omp.thinking.high": "Visoko",
  "prompt.omp.thinking.xhigh": "Zelo visoko",
  "prompt.omp.thinking.max": "Največ",
  "prompt.omp.advisor.title": "Svetovalec",
  "prompt.omp.advisor.on": "Vklopljeno",
  "prompt.omp.advisor.off": "Izklopljeno",
  "prompt.omp.approval.title": "Odobritev",
  "prompt.omp.approval.alwaysAsk": "Vedno vprašaj",
  "prompt.omp.approval.write": "Pisanje",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom OMP se povezuje ta aplikacija.",
  ...
  "help.tabs.date": "Pregled funkcij",
  "help.tabs.introduction": "Zavihki organizirajo delo in aktivne seje.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree je ločen delovni imenik za projekt.",
  ...
  "toast.update.description": "Nova različica OMP ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.chain.checkConfig": "Preverite imena konfiguriranega ponudnika in modela.",
  "error.chain.mcpFailed": "Strežnik MCP »{{name}}« je odpovedal.",
  ...
  "sidebar.gettingStarted.line1": "Za začetek odprite projekt.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za OMP",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako OMP izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali OMP sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo OMP.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene OMP",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico OMP.",
  ...
  "settings.metadata.scope.user": "Uporabnik",
