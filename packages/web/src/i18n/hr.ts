...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "OMP se nije uspio učitati",
  "Prozor aplikacije OMP neočekivano je zatvoren",
  "OMP ne reagira",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi OMP",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u OMP.",
  ...
  "prompt.omp.thinking.title": "Napor razmišljanja",
  ...
  "prompt.omp.thinking.xhigh": "Razmišljanje: Vrlo visoko",
  "prompt.omp.thinking.max": "Razmišljanje: Maksimalno",
  "prompt.omp.advisor.title": "Savjetnik",
  "prompt.omp.advisor.on": "Savjetnik: Uključeno",
  "prompt.omp.advisor.off": "Savjetnik: Isključeno",
  "prompt.omp.approval.title": "Odobrenje alata",
  "prompt.omp.approval.alwaysAsk": "Odobrenje: Pitajte",
  "prompt.omp.approval.write": "Odobrenje: Pisanje",
  "prompt.omp.approval.yolo": "Odobrenje: YOLO",
  ...
  "dialog.server.description": "Promijenite na koji se OMP poslužitelj povezuje ova aplikacija.",
  ...
  "help.tabs.date": "Pregled značajke",
  "help.tabs.introduction": "Kartice organiziraju rad i aktivne sesije.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree je zaseban radni direktorij za projekt.",
  ...
  "toast.update.description": "Nova verzija OMP ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.chain.checkConfig": "Provjerite nazive konfiguriranog pružatelja usluge i modela.",
  "error.chain.mcpFailed":
    "MCP poslužitelj \"{{name}}\" nije uspio.",
  ...
  "sidebar.gettingStarted.line1": "Otvorite projekt da biste započeli.",
  ...
  "app.name.desktop": "OMP Radna površina",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za OMP",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako OMP izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li OMP slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je OMP tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se OMP pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju OMP.",
  ...
  "settings.metadata.scope.native": "Izvorno",
  "settings.metadata.scope.global": "Globalno",
  "settings.metadata.pluginKind.marketplace": "Tržnica",
