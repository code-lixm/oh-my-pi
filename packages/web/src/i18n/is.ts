...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða OMP",
  "OMP-glugganum var óvænt lokað",
  "OMP svarar ekki",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá OMP",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í OMP.",
  ...
  "prompt.omp.thinking.title": "Hugsunarátak",
  "prompt.omp.thinking.off": "Hugsun: Slökkt",
  "prompt.omp.thinking.auto": "Hugsun: Sjálfvirk",
  "prompt.omp.thinking.minimal": "Hugsun: Lágmark",
  "prompt.omp.thinking.low": "Hugsun: Lág",
  "prompt.omp.thinking.medium": "Hugsun: Miðlungs",
  "prompt.omp.thinking.high": "Hugsun: Mikil",
  "prompt.omp.thinking.xhigh": "Hugsun: Mjög mikil",
  "prompt.omp.thinking.max": "Hugsun: Hámark",
  "prompt.omp.advisor.title": "Ráðgjafi",
  "prompt.omp.advisor.on": "Ráðgjafi: Kveikt",
  "prompt.omp.advisor.off": "Ráðgjafi: Slökkt",
  "prompt.omp.approval.title": "Samþykki verkfæra",
  "prompt.omp.approval.alwaysAsk": "Samþykki: Spurðu",
  "prompt.omp.approval.write": "Samþykki: Skrifa",
  "prompt.omp.approval.yolo": "Samþykki: YOLO",
  ...
  "dialog.server.description": "Skiptu um hvaða OMP miðlara þetta app tengist.",
  ...
  "help.tabs.date": "Yfirlit yfir eiginleika",
  "help.tabs.introduction": "Flipar skipuleggja vinnu og virkar lotur.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree er aðskilin vinnumappa fyrir verkefni.",
  ...
  "toast.update.description": "Ný útgáfa af OMP ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.chain.checkConfig": "Athugaðu heiti stilltrar þjónustuveitu og líkans.",
  "error.chain.mcpFailed": "MCP-þjónninn „{{name}}“ brást.",
  ...
  "sidebar.gettingStarted.line1": "Opnaðu verkefni til að byrja.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir OMP",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig OMP lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort OMP fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig OMP er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar OMP ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af OMP.",
  ...
  "settings.metadata.scope.user": "Notandi",
  "settings.metadata.scope.project": "Verkefni",
  "settings.metadata.scope.native": "Innfætt",
  "settings.metadata.scope.global": "Altækt",
  "settings.metadata.pluginKind.marketplace": "Markaðstorg",
