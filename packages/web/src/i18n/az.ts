...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP sənədləri",
  "desktop.menu.shareFeedback": "Rəy bildir",
  "desktop.menu.reportBug": "Xəta bildir",
  "desktop.menu.ariaLabel": "OMP menyusu",
  ...
  "desktop.recovery.loadFailed": "OMP yüklənə bilmədi",
  "desktop.recovery.terminated": "OMP pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "OMP cavab vermir",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və OMP-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və OMP-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və OMP-da {{provider}} modellərindən istifadə edin.",
  ...
  "prompt.omp.thinking.title": "Düşünmə səviyyəsi",
  "prompt.omp.thinking.off": "Düşünmə: Söndürülüb",
  "prompt.omp.thinking.auto": "Düşünmə: Avtomatik",
  "prompt.omp.thinking.minimal": "Düşünmə: Minimum",
  "prompt.omp.thinking.low": "Düşünmə: Aşağı",
  "prompt.omp.thinking.medium": "Düşünmə: Orta",
  "prompt.omp.thinking.high": "Düşünmə: Yüksək",
  "prompt.omp.thinking.xhigh": "Düşünmə: Çox yüksək",
  "prompt.omp.thinking.max": "Düşünmə: Maksimum",
  "prompt.omp.advisor.title": "Məsləhətçi",
  "prompt.omp.advisor.on": "Məsləhətçi: Aktiv",
  "prompt.omp.advisor.off": "Məsləhətçi: Deaktiv",
  "prompt.omp.approval.title": "Alət təsdiqi",
  "prompt.omp.approval.alwaysAsk": "Təsdiq: Həmişə soruş",
  "prompt.omp.approval.write": "Təsdiq: Yazma",
  "prompt.omp.approval.yolo": "Təsdiq: YOLO",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu OMP serverini dəyişdirin.",
  ...
  "help.tabs.date": "Funksiyalara ümumi baxış",
  "help.tabs.introduction": "Vərəqlər işi və aktiv sessiyaları təşkil edir.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree layihə üçün ayrıca iş qovluğudur.",
  ...
  "toast.update.description": "OMP-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.chain.checkConfig": "Konfiqurasiya edilmiş provayderin və modelin adlarını yoxlayın.",
  "error.chain.mcpFailed":
    "MCP serveri «{{name}}» işləmədi.",
  ...
  "sidebar.gettingStarted.line1": "Başlamaq üçün layihə açın.",
  ...
  "settings.general.row.language.description": "OMP üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "OMP-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "OMP-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "OMP-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "OMP açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "OMP-un ən son versiyasından istifadə edirsiniz.",
  ...
  "settings.metadata.scope.user": "İstifadəçi",
  "settings.metadata.scope.project": "Layihə",
  "settings.metadata.scope.native": "Yerli",
  "settings.metadata.scope.global": "Qlobal",
  "settings.metadata.pluginKind.marketplace": "Bazar yeri",
