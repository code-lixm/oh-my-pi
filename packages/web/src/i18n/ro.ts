...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra OMP s-a închis neașteptat",
  "desktop.recovery.unresponsive": "OMP nu răspunde",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de OMP",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în OMP.",
  ...
  "prompt.omp.thinking.title": "Efort de gândire",
  "prompt.omp.thinking.off": "Gândire: Dezactivată",
  "prompt.omp.thinking.auto": "Gândire: Automată",
  "prompt.omp.thinking.minimal": "Gândire: Minimă",
  "prompt.omp.thinking.low": "Gândire: Redusă",
  "prompt.omp.thinking.medium": "Gândire: Medie",
  "prompt.omp.thinking.high": "Gândire: Ridicată",
  "prompt.omp.thinking.xhigh": "Gândire: Foarte ridicată",
  "prompt.omp.thinking.max": "Gândire: Maximă",
  "prompt.omp.advisor.title": "Consilier",
  "prompt.omp.advisor.on": "Consilier: Activat",
  "prompt.omp.advisor.off": "Consilier: Dezactivat",
  "prompt.omp.approval.title": "Aprobarea uneltelor",
  "prompt.omp.approval.alwaysAsk": "Aprobare: Întreabă",
  "prompt.omp.approval.write": "Aprobare: Scriere",
  "prompt.omp.approval.yolo": "Aprobare: YOLO",
  ...
  "dialog.server.description": "Schimbă serverul OMP la care se conectează aplicația.",
  ...
  "help.tabs.date": "Prezentare generală a funcționalității",
  "help.tabs.introduction": "Filele organizează activitatea și sesiunile active.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Un worktree este un director de lucru separat pentru un proiect.",
  ...
  "toast.update.description": "O nouă versiune OMP ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.chain.checkConfig": "Verificați numele configurate pentru furnizor și model.",
  "error.chain.mcpFailed": "Serverul MCP „{{name}}” a eșuat.",
  ...
  "sidebar.gettingStarted.line1": "Deschideți un proiect pentru a începe.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru OMP",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul OMP pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă OMP urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema OMP.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea OMP",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune OMP.",
  ...
  "settings.metadata.scope.user": "Utilizator",
  "settings.metadata.scope.project": "Proiect",
  "settings.metadata.scope.native": "Nativ",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Piață",
