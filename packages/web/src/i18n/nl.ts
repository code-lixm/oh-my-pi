...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP-documentatie",
  ...
  "desktop.recovery.loadFailed": "OMP kan niet worden geladen",
  "desktop.recovery.terminated": "Het OMP-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "OMP reageert niet",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door OMP",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in OMP te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in OMP te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in OMP te gebruiken.",
  ...
  "prompt.omp.thinking.title": "Denkintensiteit",
  "prompt.omp.thinking.off": "Denken: Uit",
  "prompt.omp.thinking.auto": "Denken: Automatisch",
  "prompt.omp.thinking.minimal": "Denken: Minimaal",
  "prompt.omp.thinking.low": "Denken: Laag",
  "prompt.omp.thinking.medium": "Denken: Gemiddeld",
  "prompt.omp.thinking.high": "Denken: Hoog",
  "prompt.omp.thinking.xhigh": "Denken: Extra hoog",
  "prompt.omp.thinking.max": "Denken: Maximaal",
  "prompt.omp.advisor.title": "Adviseur",
  "prompt.omp.advisor.on": "Adviseur: Aan",
  "prompt.omp.advisor.off": "Adviseur: Uit",
  "prompt.omp.approval.title": "Goedkeuring van tools",
  "prompt.omp.approval.alwaysAsk": "Goedkeuring: Vragen",
  "prompt.omp.approval.write": "Goedkeuring: Schrijven",
  "prompt.omp.approval.yolo": "Goedkeuring: YOLO",
  ...
  "dialog.server.description": "Wijzig met welke OMP-server deze app verbinding maakt.",
  ...
  "help.tabs.date": "Functieoverzicht",
  "help.tabs.introduction": "Tabbladen organiseren werk en actieve sessies.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Een worktree is een aparte werkmap voor een project.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van OMP ({{version}}) beschikbaar om te installeren.",
  ...
  "error.chain.checkConfig": "Controleer de namen van de geconfigureerde provider en het model.",
  "error.chain.mcpFailed": "MCP-server \"{{name}}\" is mislukt.",
  ...
  "sidebar.gettingStarted.line1": "Open een project om aan de slag te gaan.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor OMP",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe OMP eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of OMP het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van OMP aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer OMP wordt gestart",
  ...
  "settings.updates.toast.latest.title": "OMP is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van OMP.",
  ...
  "settings.metadata.scope.user": "Gebruiker",
  "settings.metadata.scope.project": "Project",
  "settings.metadata.scope.native": "Systeemeigen",
  "settings.metadata.scope.global": "Globaal",
  "settings.metadata.pluginKind.marketplace": "Marktplaats",
