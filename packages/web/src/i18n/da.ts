...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OMP",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i OMP.",
  ...
  "prompt.omp.thinking.title": "Tænkeindsats",
  "prompt.omp.thinking.off": "Tænkning: Deaktiveret",
  "prompt.omp.thinking.auto": "Tænkning: Automatisk",
  "prompt.omp.thinking.minimal": "Tænkning: Minimal",
  "prompt.omp.thinking.low": "Tænkning: Lav",
  "prompt.omp.thinking.medium": "Tænkning: Mellem",
  "prompt.omp.thinking.high": "Tænkning: Høj",
  "prompt.omp.thinking.xhigh": "Tænkning: Ekstra høj",
  "prompt.omp.thinking.max": "Tænkning: Maksimal",
  "prompt.omp.advisor.title": "Rådgiver",
  "prompt.omp.advisor.on": "Rådgiver: Aktiveret",
  "prompt.omp.advisor.off": "Rådgiver: Deaktiveret",
  "prompt.omp.approval.title": "Værktøjsgodkendelse",
  "prompt.omp.approval.alwaysAsk": "Godkendelse: Spørg altid",
  "prompt.omp.approval.write": "Godkendelse: Skrivning",
  "prompt.omp.approval.yolo": "Godkendelse: YOLO",
  ...
  "dialog.server.description": "Skift hvilken OMP-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OMP ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.chain.checkConfig": "Kontrollér navnene på den konfigurerede udbyder og model.",
  "error.chain.mcpFailed": "MCP-serveren \"{{name}}\" mislykkedes.",
  ...
  "sidebar.gettingStarted.line1": "Åbn et projekt for at komme i gang.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OMP",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OMP ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om OMP skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas OMPs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OMP starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OMP.",
  ...
  "settings.metadata.scope.user": "Bruger",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Indbygget",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Markedsplads",
  ...
  "desktop.recovery.loadFailed": "OMP kunne ikke indlæses",
  "desktop.recovery.terminated": "OMP-vinduet blev uventet afsluttet",
  ...
  "help.tabs.date": "Oversigt over funktioner",
  "help.tabs.introduction": "Faner organiserer arbejde og aktive sessioner.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Et worktree er en separat arbejdsmappe til et projekt.",
}
