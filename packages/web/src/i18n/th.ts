...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด OMP ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง OMP หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "OMP ไม่ตอบสนอง",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย OMP",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OMP",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OMP",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OMP",
  ...
  "prompt.omp.thinking.title": "ระดับการคิด",
  "prompt.omp.thinking.off": "การคิด: ปิด",
  "prompt.omp.thinking.auto": "การคิด: อัตโนมัติ",
  "prompt.omp.thinking.minimal": "การคิด: น้อยที่สุด",
  "prompt.omp.thinking.low": "การคิด: ต่ำ",
  "prompt.omp.thinking.medium": "การคิด: ปานกลาง",
  "prompt.omp.thinking.high": "การคิด: สูง",
  "prompt.omp.thinking.xhigh": "การคิด: สูงมาก",
  "prompt.omp.thinking.max": "การคิด: สูงสุด",
  "prompt.omp.advisor.title": "ที่ปรึกษา",
  "prompt.omp.advisor.on": "ที่ปรึกษา: เปิด",
  "prompt.omp.advisor.off": "ที่ปรึกษา: ปิด",
  "prompt.omp.approval.title": "การอนุมัติเครื่องมือ",
  "prompt.omp.approval.alwaysAsk": "การอนุมัติ: ถาม",
  "prompt.omp.approval.write": "การอนุมัติ: เขียน",
  "prompt.omp.approval.yolo": "การอนุมัติ: YOLO",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ OMP ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "help.tabs.date": "ภาพรวมฟีเจอร์",
  "help.tabs.introduction": "แท็บช่วยจัดระเบียบงานและเซสชันที่ใช้งานอยู่",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "เวิร์กทรีคือไดเรกทอรีการทำงานแยกต่างหากสำหรับโปรเจกต์",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ OMP ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.chain.checkConfig": "ตรวจสอบชื่อผู้ให้บริการและโมเดลที่กำหนดค่าไว้",
  "error.chain.mcpFailed": "เซิร์ฟเวอร์ MCP \"{{name}}\" ทำงานล้มเหลว",
  ...
  "sidebar.gettingStarted.line1": "เปิดโปรเจกต์เพื่อเริ่มต้นใช้งาน",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ OMP",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ OMP บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ OMP ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ OMP",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ OMP เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน OMP เวอร์ชันล่าสุด",
  ...
  "settings.metadata.scope.user": "ผู้ใช้",
  "settings.metadata.scope.project": "โปรเจกต์",
  "settings.metadata.scope.native": "เนทีฟ",
  "settings.metadata.scope.global": "ส่วนกลาง",
  "settings.metadata.pluginKind.marketplace": "มาร์เก็ตเพลส",
