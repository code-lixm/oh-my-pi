...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o OMP",
  "desktop.recovery.terminated": "A janela do OMP foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O OMP não está respondendo",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OMP",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OMP.",
  ...
  "prompt.omp.thinking.title": "Esforço de raciocínio",
  "prompt.omp.thinking.off": "Raciocínio: Desativado",
  "prompt.omp.thinking.auto": "Raciocínio: Automático",
  "prompt.omp.thinking.minimal": "Raciocínio: Mínimo",
  "prompt.omp.thinking.low": "Raciocínio: Baixo",
  "prompt.omp.thinking.medium": "Raciocínio: Médio",
  "prompt.omp.thinking.high": "Raciocínio: Alto",
  "prompt.omp.thinking.xhigh": "Raciocínio: Muito alto",
  "prompt.omp.thinking.max": "Raciocínio: Máximo",
  "prompt.omp.advisor.title": "Consultor",
  "prompt.omp.advisor.on": "Consultor: Ativado",
  "prompt.omp.advisor.off": "Consultor: Desativado",
  "prompt.omp.approval.title": "Aprovação de ferramentas",
  "prompt.omp.approval.alwaysAsk": "Aprovação: Perguntar",
  "prompt.omp.approval.write": "Aprovação: Escrita",
  "prompt.omp.approval.yolo": "Aprovação: YOLO",
  ...
  "dialog.server.description": "Trocar para qual servidor OMP este aplicativo se conecta.",
  ...
  "help.tabs.date": "Visão geral dos recursos",
  "help.tabs.introduction": "As abas organizam o trabalho e as sessões ativas.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Um worktree é um diretório de trabalho separado para um projeto.",
  ...
  "toast.update.description": "Uma nova versão do OMP ({{version}}) está disponível para instalação.",
  ...
  "error.chain.checkConfig": "Verifique os nomes do provedor e do modelo configurados.",
  "error.chain.mcpFailed": "O servidor MCP \"{{name}}\" falhou.",
  ...
  "sidebar.gettingStarted.line1": "Abra um projeto para começar.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OMP",
  ...
  "settings.general.row.appearance.description": "Personalize como o OMP aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OMP segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OMP é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OMP iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OMP.",
  ...
  "settings.metadata.scope.user": "Usuário",
  "settings.metadata.scope.project": "Projeto",
  "settings.metadata.scope.native": "Nativo",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Mercado",
