...
export const dict = {
  ...
  "desktop.menu.documentation": "OMPドキュメント",
  "desktop.menu.shareFeedback": "フィードバックを送信",
  "desktop.menu.reportBug": "バグを報告",
  "desktop.menu.ariaLabel": "OMPメニュー",
  ...
  "desktop.recovery.loadFailed": "OMPを読み込めませんでした",
  "desktop.recovery.terminated": "OMPのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "OMPが応答していません",
  ...
  "dialog.model.unpaid.freeModels.title": "OMPが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OMPで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOMPで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OMPで{{provider}}モデルを使用してください。",
  ...
  "prompt.omp.thinking.title": "思考の強度",
  "prompt.omp.thinking.off": "思考：オフ",
  ...
  "prompt.omp.thinking.xhigh": "思考：非常に高い",
  "prompt.omp.thinking.max": "思考：最大",
  "prompt.omp.advisor.title": "アドバイザー",
  "prompt.omp.advisor.on": "アドバイザー：オン",
  "prompt.omp.advisor.off": "アドバイザー：オフ",
  "prompt.omp.approval.title": "ツールの承認",
  "prompt.omp.approval.alwaysAsk": "承認：毎回確認",
  "prompt.omp.approval.write": "承認：書き込み",
  "prompt.omp.approval.yolo": "承認：YOLO",
  ...
  "dialog.server.description": "このアプリが接続するOMPサーバーを切り替えます。",
  ...
  "help.tabs.date": "機能の概要",
  "help.tabs.introduction": "タブで作業とアクティブなセッションを整理します。",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "worktree は、プロジェクト用の独立した作業ディレクトリです。",
  ...
  "toast.update.description": "OMPの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.chain.checkConfig": "設定されているプロバイダー名とモデル名を確認してください。",
  "error.chain.mcpFailed": "MCP サーバー「{{name}}」でエラーが発生しました。",
  ...
  "sidebar.gettingStarted.line1": "開始するにはプロジェクトを開いてください。",
  ...
  "settings.general.row.language.description": "OMPの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOMPの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OMPがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OMPのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OMP の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OMP は最新バージョンです。",
  ...
  "settings.metadata.scope.user": "ユーザー",
  "settings.metadata.scope.project": "プロジェクト",
  "settings.metadata.scope.native": "ネイティブ",
  "settings.metadata.scope.global": "グローバル",
  "settings.metadata.pluginKind.marketplace": "マーケットプレイス",
