...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar OMP",
  "desktop.recovery.terminated": "La ventana de OMP se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "OMP no responde",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OMP",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OMP.",
  ...
  "prompt.omp.thinking.title": "Esfuerzo de razonamiento",
  "prompt.omp.thinking.off": "Razonamiento: Desactivado",
  "prompt.omp.thinking.auto": "Razonamiento: Automático",
  "prompt.omp.thinking.minimal": "Razonamiento: Mínimo",
  "prompt.omp.thinking.low": "Razonamiento: Bajo",
  "prompt.omp.thinking.medium": "Razonamiento: Medio",
  "prompt.omp.thinking.high": "Razonamiento: Alto",
  "prompt.omp.thinking.xhigh": "Razonamiento: Muy alto",
  "prompt.omp.thinking.max": "Razonamiento: Máximo",
  "prompt.omp.advisor.title": "Asesor",
  "prompt.omp.advisor.on": "Asesor: Activado",
  "prompt.omp.advisor.off": "Asesor: Desactivado",
  "prompt.omp.approval.title": "Aprobación de herramientas",
  "prompt.omp.approval.alwaysAsk": "Aprobación: Preguntar siempre",
  "prompt.omp.approval.write": "Aprobación: Escritura",
  "prompt.omp.approval.yolo": "Aprobación: YOLO",
  ...
  "dialog.server.description": "Cambiar el servidor de OMP al que se conecta esta aplicación.",
  ...
  "help.tabs.date": "Descripción general de las funciones",
  "help.tabs.introduction": "Las pestañas organizan el trabajo y las sesiones activas.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Un worktree es un directorio de trabajo independiente para un proyecto.",
  ...
  "toast.update.description": "Una nueva versión de OMP ({{version}}) está disponible para instalar.",
  ...
  "error.chain.checkConfig": "Comprueba los nombres del proveedor y del modelo configurados.",
  "error.chain.mcpFailed": "El servidor MCP «{{name}}» ha fallado.",
  ...
  "sidebar.gettingStarted.line1": "Abre un proyecto para empezar.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OMP",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OMP en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OMP sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OMP.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OMP",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OMP.",
  ...
  "settings.metadata.scope.user": "Usuario",
  "settings.metadata.scope.project": "Proyecto",
  "settings.metadata.scope.native": "Nativo",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Mercado de complementos",
