...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OMPn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OMPssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja OMPssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OMPssa.",
  ...
  "prompt.omp.thinking.title": "Ajattelun taso",
  "prompt.omp.thinking.off": "Ajattelu: Pois käytöstä",
  "prompt.omp.thinking.auto": "Ajattelu: Automaattinen",
  "prompt.omp.thinking.minimal": "Ajattelu: Vähäinen",
  "prompt.omp.thinking.low": "Ajattelu: Matala",
  "prompt.omp.thinking.medium": "Ajattelu: Keskitasoinen",
  "prompt.omp.thinking.high": "Ajattelu: Korkea",
  "prompt.omp.thinking.xhigh": "Ajattelu: Erittäin korkea",
  "prompt.omp.thinking.max": "Ajattelu: Enimmäistaso",
  "prompt.omp.advisor.title": "Neuvoja",
  "prompt.omp.advisor.on": "Neuvoja: Käytössä",
  "prompt.omp.advisor.off": "Neuvoja: Pois käytöstä",
  "prompt.omp.approval.title": "Työkalujen hyväksyntä",
  "prompt.omp.approval.alwaysAsk": "Hyväksyntä: Kysy aina",
  "prompt.omp.approval.write": "Hyväksyntä: Kirjoitus",
  "prompt.omp.approval.yolo": "Hyväksyntä: YOLO",
  ...
  "dialog.server.description": "Vaihda OMP-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "toast.update.description": "OMPn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.chain.checkConfig": "Tarkista määritetyn palveluntarjoajan ja mallin nimet.",
  "error.chain.mcpFailed": "MCP-palvelin ”{{name}}” epäonnistui.",
  ...
  "sidebar.gettingStarted.line1": "Aloita avaamalla projekti.",
  ...
  "settings.general.row.language.description": "Vaihda OMPn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä OMP näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö OMP järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta OMPn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun OMP käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät OMPn uusinta versiota.",
  ...
  "settings.metadata.scope.user": "Käyttäjä",
  "settings.metadata.scope.project": "Projekti",
  "settings.metadata.scope.native": "Natiivi",
  "settings.metadata.scope.global": "Yleinen",
  "settings.metadata.pluginKind.marketplace": "Markkinapaikka",
  ...
  "desktop.recovery.loadFailed": "OMPn lataaminen epäonnistui",
  "desktop.recovery.terminated": "OMP-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "OMP ei vastaa",
  ...
  "help.tabs.date": "Ominaisuuksien yleiskatsaus",
  "help.tabs.introduction": "Välilehdet järjestävät työn ja aktiiviset istunnot.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree on projektin erillinen työhakemisto.",
}
