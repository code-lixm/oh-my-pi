...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP 文件",
  "desktop.menu.shareFeedback": "提供意見回饋",
  "desktop.menu.reportBug": "回報錯誤",
  "desktop.menu.ariaLabel": "OMP 選單",
  ...
  "desktop.recovery.loadFailed": "OMP 載入失敗",
  "desktop.recovery.terminated": "OMP 視窗意外終止",
  "desktop.recovery.unresponsive": "OMP 沒有回應",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OMP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OMP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 OMP 中使用 {{provider}} 模型。",
  ...
  "prompt.omp.thinking.title": "思考強度",
  "prompt.omp.thinking.off": "思考：關閉",
  "prompt.omp.thinking.auto": "思考：自動",
  ...
  "prompt.omp.thinking.xhigh": "思考：極高",
  "prompt.omp.thinking.max": "思考：最大",
  "prompt.omp.advisor.title": "審閱助手",
  "prompt.omp.advisor.on": "審閱：開啟",
  "prompt.omp.advisor.off": "審閱：關閉",
  "prompt.omp.approval.title": "工具核准",
  "prompt.omp.approval.alwaysAsk": "核准：詢問",
  "prompt.omp.approval.write": "核准：寫入",
  "prompt.omp.approval.yolo": "核准：YOLO",
  ...
  "dialog.server.description": "切換此應用程式連線的 OMP 伺服器。",
  ...
  "help.tabs.date": "功能概覽",
  "help.tabs.introduction": "分頁用於整理工作和作用中的工作階段。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "OMP 有新版本 ({{version}}) 可安裝。",
  ...
  "error.chain.checkConfig": "請檢查已設定的提供者和模型名稱。",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」執行失敗。",
  ...
  "sidebar.gettingStarted.line1": "開啟一個專案以開始使用。",
  ...
  "settings.general.row.language.description": "變更 OMP 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 OMP 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 OMP 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OMP 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OMP 啟動時自動檢查更新",
  ...
  "settings.metadata.scope.user": "使用者",
  "settings.metadata.scope.project": "專案",
  "settings.metadata.scope.native": "原生",
  "settings.metadata.scope.global": "全域",
  "settings.metadata.pluginKind.marketplace": "外掛市集",
