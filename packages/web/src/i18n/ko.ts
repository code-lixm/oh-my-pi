...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OMP에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 OMP에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 OMP에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 OMP에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.omp.thinking.title": "사고 수준",
  "prompt.omp.thinking.off": "사고: 꺼짐",
  "prompt.omp.thinking.auto": "사고: 자동",
  "prompt.omp.thinking.minimal": "사고: 최소",
  "prompt.omp.thinking.low": "사고: 낮음",
  "prompt.omp.thinking.medium": "사고: 중간",
  "prompt.omp.thinking.high": "사고: 높음",
  "prompt.omp.thinking.xhigh": "사고: 매우 높음",
  "prompt.omp.thinking.max": "사고: 최대",
  "prompt.omp.advisor.title": "조언자",
  "prompt.omp.advisor.on": "조언자: 켜짐",
  "prompt.omp.advisor.off": "조언자: 꺼짐",
  "prompt.omp.approval.title": "도구 승인",
  "prompt.omp.approval.alwaysAsk": "승인: 항상 묻기",
  "prompt.omp.approval.write": "승인: 쓰기",
  "prompt.omp.approval.yolo": "승인: YOLO",
  ...
  "dialog.server.description": "이 앱이 연결할 OMP 서버를 전환합니다.",
  ...
  "toast.update.description": "OMP의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.chain.checkConfig": "설정된 제공업체 및 모델 이름을 확인하세요.",
  "error.chain.mcpFailed": "MCP 서버 \"{{name}}\"에 오류가 발생했습니다.",
  ...
  "sidebar.gettingStarted.line1": "시작하려면 프로젝트를 여세요.",
  ...
  "settings.general.row.language.description": "OMP 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 OMP가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "OMP가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "OMP 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "OMP를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 OMP를 사용 중입니다.",
  ...
  "settings.metadata.scope.user": "사용자",
  "settings.metadata.scope.project": "프로젝트",
  "settings.metadata.scope.native": "네이티브",
  "settings.metadata.scope.global": "전역",
  "settings.metadata.pluginKind.marketplace": "마켓플레이스",
  ...
  "help.tabs.date": "기능 개요",
  "help.tabs.introduction": "탭은 작업과 활성 세션을 정리합니다.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "워크트리는 프로젝트와 연결된 별도의 작업 디렉터리입니다.",
  ...
  "desktop.menu.documentation": "OMP 문서",
  "desktop.menu.shareFeedback": "피드백 보내기",
  "desktop.menu.reportBug": "버그 신고",
  "desktop.menu.ariaLabel": "OMP 메뉴",
  ...
  "desktop.recovery.loadFailed": "OMP를 불러오지 못했습니다",
  "desktop.recovery.terminated": "OMP 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "OMP가 응답하지 않습니다",
