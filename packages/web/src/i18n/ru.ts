...
export const dict = {
  ...
  "desktop.menu.documentation": "Документация OMP",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить OMP",
  "desktop.recovery.terminated": "Окно OMP неожиданно завершило работу",
  "desktop.recovery.unresponsive": "OMP не отвечает",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от OMP",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в OMP.",
  ...
  "prompt.omp.thinking.title": "Интенсивность мышления",
  "prompt.omp.thinking.off": "Мышление: Отключено",
  "prompt.omp.thinking.auto": "Мышление: Автоматически",
  "prompt.omp.thinking.minimal": "Мышление: Минимальное",
  "prompt.omp.thinking.low": "Мышление: Низкое",
  "prompt.omp.thinking.medium": "Мышление: Среднее",
  "prompt.omp.thinking.high": "Мышление: Высокое",
  "prompt.omp.thinking.xhigh": "Мышление: Очень высокое",
  "prompt.omp.thinking.max": "Мышление: Максимальное",
  "prompt.omp.advisor.title": "Советник",
  "prompt.omp.advisor.on": "Советник: Включён",
  "prompt.omp.advisor.off": "Советник: Отключён",
  "prompt.omp.approval.title": "Подтверждение инструментов",
  "prompt.omp.approval.alwaysAsk": "Подтверждение: Всегда спрашивать",
  "prompt.omp.approval.write": "Подтверждение: Запись",
  "prompt.omp.approval.yolo": "Подтверждение: YOLO",
  ...
  "dialog.server.description": "Выберите сервер OMP, к которому подключается приложение.",
  ...
  "help.tabs.date": "Обзор функции",
  "help.tabs.introduction": "Вкладки упорядочивают работу и активные сеансы.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Рабочее дерево — это отдельный рабочий каталог проекта.",
  ...
  "toast.update.description": "Новая версия OMP ({{version}}) доступна для установки.",
  ...
  "error.chain.checkConfig": "Проверьте имена настроенных провайдера и модели.",
  "error.chain.mcpFailed":
    "Сервер MCP «{{name}}» дал сбой.",
  ...
  "sidebar.gettingStarted.line1": "Откройте проект, чтобы начать работу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения OMP",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид OMP на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли OMP системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление OMP.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске OMP",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию OMP.",
  ...
  "settings.metadata.scope.user": "Пользователь",
  "settings.metadata.scope.project": "Проект",
  "settings.metadata.scope.native": "Нативный",
  "settings.metadata.scope.global": "Глобальный",
