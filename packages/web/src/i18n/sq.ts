...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja OMP u mbyll papritur",
  "desktop.recovery.unresponsive": "OMP nuk po përgjigjet",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga OMP",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në OMP.",
  ...
  "prompt.omp.thinking.title": "Të menduarit",
  "prompt.omp.thinking.off": "Çaktivizuar",
  "prompt.omp.thinking.auto": "Automatik",
  "prompt.omp.thinking.minimal": "Minimal",
  "prompt.omp.thinking.low": "I ulët",
  "prompt.omp.thinking.medium": "Mesatar",
  "prompt.omp.thinking.high": "I lartë",
  "prompt.omp.thinking.xhigh": "Shumë i lartë",
  "prompt.omp.thinking.max": "Maksimal",
  "prompt.omp.advisor.title": "Këshilltar",
  "prompt.omp.advisor.on": "Aktivizuar",
  "prompt.omp.advisor.off": "Çaktivizuar",
  "prompt.omp.approval.title": "Miratimi",
  "prompt.omp.approval.alwaysAsk": "Pyet gjithmonë",
  "prompt.omp.approval.write": "Shkrim",
  "prompt.omp.approval.yolo": "YOLO",
  ...
  "dialog.server.description": "Ndrysho me cilin server OMP lidhet ky aplikacion.",
  ...
  "help.tabs.date": "Pasqyrë e veçorive",
  "help.tabs.introduction": "Skedat organizojnë punën dhe sesionet aktive.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Një worktree është një direktori pune e veçantë për një projekt.",
  ...
  "toast.update.description": "Një version i ri i OMP ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e konfiguruar të ofruesit dhe modelit.",
  "error.chain.mcpFailed": "Serveri MCP \"{{name}}\" dështoi.",
  ...
  "sidebar.gettingStarted.line1": "Hapni një projekt për të filluar.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për OMP",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket OMP në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse OMP ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e OMP.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset OMP",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të OMP.",
  ...
  "settings.metadata.scope.user": "Përdorues",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Vendas",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Tregu",
