...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "OMP ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "OMP არ პასუხობს",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია OMP",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები OMP-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები OMP-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები OMP-ში.",
  ...
  "prompt.omp.thinking.title": "აზროვნების ძალისხმევა",
  "prompt.omp.thinking.off": "აზროვნება: გამორთული",
  "prompt.omp.thinking.auto": "აზროვნება: ავტომატური",
  "prompt.omp.thinking.minimal": "აზროვნება: მინიმალური",
  "prompt.omp.thinking.low": "აზროვნება: დაბალი",
  "prompt.omp.thinking.medium": "აზროვნება: საშუალო",
  "prompt.omp.thinking.high": "აზროვნება: მაღალი",
  "prompt.omp.thinking.xhigh": "აზროვნება: ძალიან მაღალი",
  "prompt.omp.thinking.max": "აზროვნება: მაქსიმალური",
  "prompt.omp.advisor.title": "მრჩეველი",
  "prompt.omp.advisor.on": "მრჩეველი: ჩართული",
  "prompt.omp.advisor.off": "მრჩეველი: გამორთული",
  "prompt.omp.approval.title": "ხელსაწყოს დადასტურება",
  "prompt.omp.approval.alwaysAsk": "დადასტურება: კითხვა",
  "prompt.omp.approval.write": "დადასტურება: ჩაწერა",
  "prompt.omp.approval.yolo": "დადასტურება: YOLO",
  ...
  "dialog.server.description": "გადართეთ რომელ OMP სერვერს უკავშირდება ეს აპი.",
  ...
  "help.tabs.date": "ფუნქციის მიმოხილვა",
  "help.tabs.introduction": "ჩანართები აწესრიგებს სამუშაოსა და აქტიურ სესიებს.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree არის პროექტისთვის განკუთვნილი ცალკე სამუშაო დირექტორია.",
  ...
  "toast.update.description": "OMP-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.chain.checkConfig": "შეამოწმეთ კონფიგურირებული პროვაიდერისა და მოდელის სახელები.",
  "error.chain.mcpFailed":
    "MCP სერვერის „{{name}}“ მუშაობა ვერ მოხერხდა.",
  ...
  "sidebar.gettingStarted.line1": "დასაწყებად გახსენით პროექტი.",
  ...
  "app.name.desktop": "OMP სამუშაო მაგიდა",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა OMP",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება OMP თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა OMP სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის OMP თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც OMP გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ OMP-ის უახლეს ვერსიას.",
  ...
  "settings.metadata.scope.user": "მომხმარებელი",
  "settings.metadata.scope.project": "პროექტი",
  "settings.metadata.scope.native": "მშობლიური",
  "settings.metadata.scope.global": "გლობალური",
  "settings.metadata.pluginKind.marketplace": "ბაზარი",
