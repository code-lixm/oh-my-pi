...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP yuklanmadi",
  "desktop.recovery.terminated": "OMP oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "OMP javob bermayapti",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va OMP’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va OMP da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va OMP da {{provider}} modellaridan foydalaning.",
  ...
  "prompt.omp.thinking.title": "Fikrlash",
  "prompt.omp.thinking.off": "Oʻchirilgan",
  "prompt.omp.thinking.auto": "Avtomatik",
  "prompt.omp.thinking.minimal": "Minimal",
  "prompt.omp.thinking.low": "Past",
  "prompt.omp.thinking.medium": "Oʻrtacha",
  "prompt.omp.thinking.high": "Yuqori",
  "prompt.omp.thinking.xhigh": "Juda yuqori",
  "prompt.omp.thinking.max": "Maksimal",
  "prompt.omp.advisor.title": "Maslahatchi",
  "prompt.omp.advisor.on": "Yoqilgan",
  "prompt.omp.advisor.off": "Oʻchirilgan",
  "prompt.omp.approval.title": "Tasdiqlash",
  "prompt.omp.approval.alwaysAsk": "Har doim soʻrang",
  "prompt.omp.approval.write": "Yozish",
  ...
  "dialog.server.description": "Ushbu ilova qaysi OMP serveriga ulanishini almashtiring.",
  ...
  "help.tabs.date": "Xususiyatlar haqida umumiy ma’lumot",
  "help.tabs.introduction": "Varaqlar ish va faol seanslarni tartibga soladi.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Ishchi daraxt loyiha uchun alohida ishchi katalogdir.",
  ...
  "toast.update.description": "OMP ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.chain.checkConfig": "Sozlangan provayder va model nomlarini tekshiring.",
  "error.chain.mcpFailed":
    "“{{name}}” MCP serveri ishlamadi.",
  ...
  "sidebar.gettingStarted.line1":
    "Boshlash uchun loyihani oching.",
  ...
  "settings.general.row.language.description": "OMP uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "OMP qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "OMP tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "OMP mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "OMP ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz OMP oxirgi versiyasini ishga tushiryapsiz.",
  ...
  "settings.metadata.scope.user": "Foydalanuvchi",
  "settings.metadata.scope.project": "Loyiha",
  "settings.metadata.scope.native": "Mahalliy",
  "settings.metadata.scope.global": "Umumiy",
  "settings.metadata.pluginKind.marketplace": "Bozor",
