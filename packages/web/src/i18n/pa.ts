...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "OMP لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "OMP دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "OMP جواب نئیں دے رہیا",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے OMP وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے OMP وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے OMP وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "prompt.omp.thinking.title": "سوچ دی سطح",
  "prompt.omp.thinking.off": "سوچ: بند",
  "prompt.omp.thinking.auto": "سوچ: خودکار",
  "prompt.omp.thinking.minimal": "سوچ: سب توں گھٹ",
  "prompt.omp.thinking.low": "سوچ: گھٹ",
  "prompt.omp.thinking.medium": "سوچ: درمیانی",
  "prompt.omp.thinking.high": "سوچ: ودھ",
  "prompt.omp.thinking.xhigh": "سوچ: بہت ودھ",
  "prompt.omp.thinking.max": "سوچ: سب توں ودھ",
  "prompt.omp.advisor.title": "مشیر",
  "prompt.omp.advisor.on": "مشیر: چالو",
  "prompt.omp.advisor.off": "مشیر: بند",
  "prompt.omp.approval.title": "آلے دی منظوری",
  "prompt.omp.approval.alwaysAsk": "منظوری: ہر واری پچھو",
  "prompt.omp.approval.write": "منظوری: لکھنا",
  ...
  "dialog.server.description": "ایہہ ایپ کس OMP سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "help.tabs.date": "فیچر دا جائزہ",
  "help.tabs.introduction": "ٹیب کم تے فعال سیشنز نوں منظم کردے نیں۔",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "ورک ٹری کسے پروجیکٹ لئی اک وکھری ورکنگ ڈائریکٹری اے۔",
  ...
  "toast.update.description": "OMP ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.chain.checkConfig": "کنفیگر کیتے گئے پرووائیڈر تے ماڈل دے ناں چیک کرو۔",
  ...
  "sidebar.gettingStarted.line1": "شروع کرن لئی اک پروجیکٹ کھولو۔",
  ...
  "settings.general.row.language.description": "OMP لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے OMP کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا OMP سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OMP نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں OMP لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی OMP دا تازہ ترین ورژن چلا رئے او۔",
