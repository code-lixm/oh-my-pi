...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP መጫን አልቻለም",
  "desktop.recovery.terminated": "OMP መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "OMP ምላሽ እየሰጠ አይደለም",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በOMP",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በOMP ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በOMP ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በOMP ይጠቀሙ።",
  ...
  "prompt.omp.thinking.title": "የማሰብ ጥረት",
  "prompt.omp.thinking.off": "ማሰብ፦ ጠፍቷል",
  "prompt.omp.thinking.auto": "ማሰብ፦ ራስ-ሰር",
  "prompt.omp.thinking.minimal": "ማሰብ፦ አነስተኛ",
  "prompt.omp.thinking.low": "ማሰብ፦ ዝቅተኛ",
  "prompt.omp.thinking.medium": "ማሰብ፦ መካከለኛ",
  "prompt.omp.thinking.high": "ማሰብ፦ ከፍተኛ",
  "prompt.omp.thinking.xhigh": "ማሰብ፦ በጣም ከፍተኛ",
  "prompt.omp.thinking.max": "ማሰብ፦ ከፍተኛው",
  "prompt.omp.advisor.title": "አማካሪ",
  "prompt.omp.advisor.on": "አማካሪ፦ በርቷል",
  "prompt.omp.advisor.off": "አማካሪ፦ ጠፍቷል",
  "prompt.omp.approval.title": "የመሣሪያ ማጽደቅ",
  "prompt.omp.approval.alwaysAsk": "ማጽደቅ፦ ሁልጊዜ ጠይቅ",
  "prompt.omp.approval.write": "ማጽደቅ፦ ጽሑፍ",
  "prompt.omp.approval.yolo": "ማጽደቅ፦ YOLO",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው OMP አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "help.tabs.date": "የባህሪያት አጠቃላይ እይታ",
  "help.tabs.introduction": "ትሮች ሥራን እና ንቁ ክፍለ ጊዜዎችን ያደራጃሉ።",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "ወርክትሪ ለአንድ ፕሮጀክት የተለየ የሥራ ማውጫ ነው።",
  ...
  "toast.update.description": "አዲሱ የOMP ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.chain.checkConfig": "የተዋቀሩትን የአቅራቢ እና የሞዴል ስሞች ያረጋግጡ።",
  "error.chain.mcpFailed": "የMCP አገልጋዩ «{{name}}» አልተሳካም።",
  ...
  "sidebar.gettingStarted.line1": "ለመጀመር ፕሮጀክት ይክፈቱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለOMP",
  ...
  "settings.general.row.appearance.description": "OMPበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "OMP ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "OMP ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "OMP ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የOMP እትም እያሄዱ ነው።",
  ...
  "settings.metadata.scope.user": "ተጠቃሚ",
  "settings.metadata.scope.project": "ፕሮጀክት",
  "settings.metadata.scope.native": "ተወላጅ",
  "settings.metadata.scope.global": "ዓለም አቀፍ",
  "settings.metadata.pluginKind.marketplace": "ገበያ",
