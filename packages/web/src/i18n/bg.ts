...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът OMP приключи неочаквано",
  "desktop.recovery.unresponsive": "OMP не отговаря",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от OMP",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в OMP.",
  ...
  "prompt.omp.thinking.title": "Интензивност на мисленето",
  "prompt.omp.thinking.off": "Мислене: Изключено",
  "prompt.omp.thinking.auto": "Мислене: Автоматично",
  "prompt.omp.thinking.minimal": "Мислене: Минимално",
  "prompt.omp.thinking.low": "Мислене: Ниско",
  "prompt.omp.thinking.medium": "Мислене: Средно",
  "prompt.omp.thinking.high": "Мислене: Високо",
  "prompt.omp.thinking.xhigh": "Мислене: Много високо",
  "prompt.omp.thinking.max": "Мислене: Максимално",
  "prompt.omp.advisor.title": "Съветник",
  "prompt.omp.advisor.on": "Съветник: Включен",
  "prompt.omp.advisor.off": "Съветник: Изключен",
  "prompt.omp.approval.title": "Одобрение на инструменти",
  "prompt.omp.approval.alwaysAsk": "Одобрение: Попитайте",
  "prompt.omp.approval.write": "Одобрение: Писане",
  "prompt.omp.approval.yolo": "Одобрение: YOLO",
  ...
  "dialog.server.description": "Превключете към кой OMP сървър се свързва това приложение.",
  ...
  "help.tabs.introduction": "Разделите организират работата и активните сесии.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree е отделна работна директория за даден проект.",
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на OMP ({{version}}).",
  ...
  "error.chain.checkConfig": "Проверете имената на конфигурирания доставчик и модел.",
  "error.chain.mcpFailed":
    "MCP сървърът „{{name}}“ не успя да се изпълни.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за OMP",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда OMP на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали OMP следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично OMP.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на OMP",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на OMP.",
  ...
  "settings.metadata.scope.user": "Потребител",
  "settings.metadata.scope.project": "Проект",
  "settings.metadata.scope.native": "Нативен",
  "settings.metadata.scope.global": "Глобален",
