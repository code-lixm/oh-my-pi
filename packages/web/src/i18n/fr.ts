...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'OMP",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'OMP",
  "desktop.recovery.terminated": "La fenêtre OMP s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "OMP ne répond pas",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OMP",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OMP.",
  ...
  "prompt.omp.thinking.title": "Effort de réflexion",
  "prompt.omp.thinking.off": "Réflexion : Désactivée",
  "prompt.omp.thinking.auto": "Réflexion : Automatique",
  "prompt.omp.thinking.minimal": "Réflexion : Minimale",
  "prompt.omp.thinking.low": "Réflexion : Faible",
  "prompt.omp.thinking.medium": "Réflexion : Moyenne",
  "prompt.omp.thinking.high": "Réflexion : Élevée",
  "prompt.omp.thinking.xhigh": "Réflexion : Très élevée",
  "prompt.omp.thinking.max": "Réflexion : Maximale",
  "prompt.omp.advisor.title": "Conseiller",
  "prompt.omp.advisor.on": "Conseiller : Activé",
  "prompt.omp.advisor.off": "Conseiller : Désactivé",
  "prompt.omp.approval.title": "Approbation des outils",
  "prompt.omp.approval.alwaysAsk": "Approbation : Toujours demander",
  "prompt.omp.approval.write": "Approbation : Écriture",
  "prompt.omp.approval.yolo": "Approbation : YOLO",
  ...
  "dialog.server.description": "Changez le serveur OMP auquel cette application se connecte.",
  ...
  "help.tabs.date": "Présentation de la fonctionnalité",
  "help.tabs.introduction": "Les onglets organisent le travail et les sessions actives.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Un worktree est un répertoire de travail distinct pour un projet.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OMP ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.chain.checkConfig": "Vérifiez les noms du fournisseur et du modèle configurés.",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OMP",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OMP sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OMP suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OMP.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OMP",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OMP.",
  ...
  "settings.metadata.scope.user": "Utilisateur",
  "settings.metadata.scope.project": "Projet",
  "settings.metadata.scope.native": "Natif",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Place de marché",
