...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da OMP",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in OMP.",
  ...
  "prompt.omp.thinking.title": "Intensità di ragionamento",
  "prompt.omp.thinking.off": "Ragionamento: Disattivato",
  "prompt.omp.thinking.auto": "Ragionamento: Automatico",
  "prompt.omp.thinking.minimal": "Ragionamento: Minimo",
  "prompt.omp.thinking.low": "Ragionamento: Basso",
  "prompt.omp.thinking.medium": "Ragionamento: Medio",
  "prompt.omp.thinking.high": "Ragionamento: Alto",
  "prompt.omp.thinking.xhigh": "Ragionamento: Molto alto",
  "prompt.omp.thinking.max": "Ragionamento: Massimo",
  "prompt.omp.advisor.title": "Consulente",
  "prompt.omp.advisor.on": "Consulente: Attivo",
  "prompt.omp.advisor.off": "Consulente: Disattivato",
  "prompt.omp.approval.title": "Approvazione degli strumenti",
  "prompt.omp.approval.alwaysAsk": "Approvazione: Chiedi sempre",
  "prompt.omp.approval.write": "Approvazione: Scrittura",
  "prompt.omp.approval.yolo": "Approvazione: YOLO",
  ...
  "dialog.server.description": "Cambia il server OMP a cui si connette l'app.",
  ...
  "help.tabs.date": "Panoramica della funzionalità",
  "help.tabs.introduction": "Le schede organizzano il lavoro e le sessioni attive.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Un worktree è una directory di lavoro separata per un progetto.",
  ...
  "toast.update.description": "Una nuova versione di OMP ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.chain.checkConfig": "Controlla i nomi del provider e del modello configurati.",
  "error.chain.mcpFailed":
    "Il server MCP \"{{name}}\" ha riscontrato un errore.",
  ...
  "sidebar.gettingStarted.line1": "Apri un progetto per iniziare.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per OMP",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di OMP sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se OMP segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di OMP.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di OMP",
  ...
  "settings.updates.toast.latest.title": "OMP è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di OMP.",
  ...
  "settings.metadata.scope.user": "Utente",
  "settings.metadata.scope.project": "Progetto",
  "settings.metadata.scope.native": "Nativo",
  "settings.metadata.scope.global": "Globale",
  "settings.metadata.pluginKind.marketplace": "Mercato",
  ...
  "desktop.menu.documentation": "Documentazione di OMP",
  "desktop.menu.shareFeedback": "Invia feedback",
  "desktop.menu.reportBug": "Segnala un bug",
  "desktop.menu.ariaLabel": "Menu OMP",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare OMP",
  "desktop.recovery.terminated": "La finestra di OMP si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "OMP non risponde",
