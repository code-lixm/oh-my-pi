...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "OMP ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "OMP جواب نہیں دے رہا",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور OMP میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور OMP میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور OMP میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "prompt.omp.thinking.title": "سوچنے کی سطح",
  "prompt.omp.thinking.off": "سوچ: بند",
  "prompt.omp.thinking.auto": "سوچ: خودکار",
  "prompt.omp.thinking.minimal": "سوچ: کم سے کم",
  "prompt.omp.thinking.low": "سوچ: کم",
  "prompt.omp.thinking.medium": "سوچ: درمیانی",
  "prompt.omp.thinking.high": "سوچ: زیادہ",
  "prompt.omp.thinking.xhigh": "سوچ: بہت زیادہ",
  "prompt.omp.thinking.max": "سوچ: زیادہ سے زیادہ",
  "prompt.omp.advisor.title": "مشیر",
  "prompt.omp.advisor.on": "مشیر: فعال",
  "prompt.omp.advisor.off": "مشیر: غیر فعال",
  "prompt.omp.approval.title": "آلات کی منظوری",
  "prompt.omp.approval.alwaysAsk": "منظوری: ہمیشہ پوچھیں",
  "prompt.omp.approval.write": "منظوری: تحریر",
  "prompt.omp.approval.yolo": "منظوری: YOLO",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس OMP سرور سے منسلک ہے۔",
  ...
  "help.tabs.date": "خصوصیات کا جائزہ",
  "help.tabs.introduction": "ٹیب کام اور فعال سیشنز کو منظم کرتے ہیں۔",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "ورک ٹری کسی پروجیکٹ کے لیے ایک علیحدہ ورکنگ ڈائریکٹری ہوتی ہے۔",
  ...
  "toast.update.description": "OMP ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.chain.checkConfig": "ترتیب کردہ پرووائیڈر اور ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": "MCP سرور \"{{name}}\" ناکام ہو گیا۔",
  ...
  "sidebar.gettingStarted.line1": "شروع کرنے کے لیے کوئی پروجیکٹ کھولیں۔",
  ...
  "settings.general.row.language.description": "OMP کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر OMP کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا OMP سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "OMP کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "OMP لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ OMP کا تازہ ترین ورژن چلا رہے ہیں۔",
  ...
  "settings.metadata.scope.user": "صارف",
  "settings.metadata.scope.project": "پروجیکٹ",
  "settings.metadata.scope.native": "مقامی",
  "settings.metadata.scope.global": "عالمی",
  "settings.metadata.pluginKind.marketplace": "بازار",
