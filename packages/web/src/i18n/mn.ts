...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP ачаалж чадсангүй",
  "desktop.recovery.terminated": "OMP цонх гэнэт хаагдсан",
  "desktop.recovery.unresponsive": "OMP хариу өгөхгүй байна",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP өгсөн үнэгүй загварууд",
  ...
  "provider.connect.apiKey.description":
    "Бүртгэлээ холбохын тулд {{provider}} API түлхүүрээ оруулаад OMP-д {{provider}} загварыг ашиглана уу.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "OMP дахь {{provider}} загваруудыг ашиглан бүртгэлээ холбохын тулд зөвшөөрлийн кодыг цуглуулах.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "Доорх кодыг оруулаад бүртгэлээ холбож, OMP-д {{provider}} загварыг ашиглана уу.",
  ...
  "prompt.omp.thinking.title": "Бодолтын хүчин чармайлт",
  "prompt.omp.thinking.off": "Бодолт: Унтраалттай",
  "prompt.omp.thinking.auto": "Бодолт: Автомат",
  "prompt.omp.thinking.minimal": "Бодолт: Хамгийн бага",
  "prompt.omp.thinking.low": "Бодолт: Бага",
  "prompt.omp.thinking.medium": "Бодолт: Дунд",
  "prompt.omp.thinking.high": "Бодолт: Өндөр",
  "prompt.omp.thinking.xhigh": "Бодолт: Маш өндөр",
  "prompt.omp.thinking.max": "Бодолт: Дээд",
  "prompt.omp.advisor.title": "Зөвлөх",
  "prompt.omp.advisor.on": "Зөвлөх: Асаалттай",
  "prompt.omp.advisor.off": "Зөвлөх: Унтраалттай",
  "prompt.omp.approval.title": "Хэрэгслийн зөвшөөрөл",
  "prompt.omp.approval.alwaysAsk": "Зөвшөөрөл: Асуух",
  "prompt.omp.approval.write": "Зөвшөөрөл: Бичих",
  "prompt.omp.approval.yolo": "Зөвшөөрөл: YOLO",
  ...
  "dialog.server.description": "Энэ апп аль OMP серверт холбогдохыг сэлгэнэ үү.",
  ...
  "help.tabs.date": "Онцлогийн тойм",
  "help.tabs.introduction": "Табууд ажил болон идэвхтэй сешнүүдийг эмхэлдэг.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Ажлын мод нь төсөлтэй холбоотой тусдаа ажлын директор юм.",
  ...
  "toast.update.description": "OMP ({{version}}) шинэ хувилбарыг одоо суулгах боломжтой.",
  ...
  "error.chain.checkConfig": "Тохируулсан үйлчилгээ үзүүлэгч болон загварын нэрийг шалгана уу.",
  "error.chain.mcpFailed":
    "MCP сервер \"{{name}}\" амжилтгүй боллоо.",
  ...
  "sidebar.gettingStarted.line1": "Эхлэхийн тулд төсөл нээнэ үү.",
  ...
  "settings.general.row.language.description": "OMP дэлгэцийн хэлийг өөрчлөх",
  ...
  "settings.general.row.appearance.description": "OMP төхөөрөмж дээрээ хэрхэн харагдахыг тохируулна уу",
  "settings.general.row.colorScheme.title": "Өнгөний схем",
  "settings.general.row.colorScheme.description":
    "OMP нь систем, цайвар эсвэл бараан загварт тохирох эсэхийг сонгоно уу",
  "settings.general.row.theme.title": "Сэдэв",
  "settings.general.row.theme.description": "OMP-г хэрхэн загварчлахыг тохируулна уу.",
  ...
  "settings.updates.row.startup.description": "OMP эхлүүлэх үед шинэчлэлтүүдийг автоматаар шалгана уу",
  ...
  "settings.updates.toast.latest.description": "Та OMP-н хамгийн сүүлийн хувилбарыг ажиллуулж байна.",
  ...
  "settings.metadata.scope.user": "Хэрэглэгч",
  "settings.metadata.scope.project": "Төсөл",
  "settings.metadata.scope.native": "Уугуул",
  "settings.metadata.scope.global": "Глобал",
  "settings.metadata.pluginKind.marketplace": "Зах зээл",
