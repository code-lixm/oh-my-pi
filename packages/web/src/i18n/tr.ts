...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP yüklenemedi",
  "desktop.recovery.terminated": "OMP penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "OMP yanıt vermiyor",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OMP'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OMP'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OMP'da {{provider}} modellerini kullanın.",
  ...
  "prompt.omp.thinking.title": "Düşünme çabası",
  "prompt.omp.thinking.off": "Düşünme: Kapalı",
  "prompt.omp.thinking.auto": "Düşünme: Otomatik",
  "prompt.omp.thinking.minimal": "Düşünme: Minimum",
  "prompt.omp.thinking.low": "Düşünme: Düşük",
  "prompt.omp.thinking.medium": "Düşünme: Orta",
  "prompt.omp.thinking.high": "Düşünme: Yüksek",
  "prompt.omp.thinking.xhigh": "Düşünme: Çok yüksek",
  "prompt.omp.thinking.max": "Düşünme: Maksimum",
  "prompt.omp.advisor.title": "Danışman",
  "prompt.omp.advisor.on": "Danışman: Açık",
  "prompt.omp.advisor.off": "Danışman: Kapalı",
  "prompt.omp.approval.title": "Araç onayı",
  "prompt.omp.approval.alwaysAsk": "Onay: Sor",
  "prompt.omp.approval.write": "Onay: Yazma",
  "prompt.omp.approval.yolo": "Onay: YOLO",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OMP sunucusuna bağlanacağını değiştirin.",
  ...
  "help.tabs.date": "Özelliklere genel bakış",
  "help.tabs.introduction": "Sekmeler, çalışmaları ve etkin oturumları düzenler.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Çalışma ağacı, bir proje için ayrı bir çalışma dizinidir.",
  ...
  "toast.update.description": "OMP'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.chain.checkConfig": "Yapılandırılmış sağlayıcı ve model adlarını kontrol edin.",
  "error.chain.mcpFailed":
    "\"{{name}}\" MCP sunucusu başarısız oldu.",
  ...
  "sidebar.gettingStarted.line1": "Başlamak için bir proje açın.",
  ...
  "settings.general.row.language.description": "OMP'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "OMP'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OMP'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OMP'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OMP başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OMP'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.metadata.scope.user": "Kullanıcı",
  "settings.metadata.scope.project": "Proje",
  "settings.metadata.scope.native": "Yerel",
  "settings.metadata.scope.global": "Genel",
  "settings.metadata.pluginKind.marketplace": "Pazar yeri",
