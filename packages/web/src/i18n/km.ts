...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច OMP ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "OMP មិនឆ្លើយតបទេ។",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ OMP",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង OMP។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង OMP ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង OMP។",
  ...
  "prompt.omp.thinking.title": "ការខិតខំប្រឹងប្រែងក្នុងការគិត",
  "prompt.omp.thinking.off": "ការគិត៖ បិទ",
  "prompt.omp.thinking.auto": "ការគិត៖ ស្វ័យប្រវត្តិ",
  "prompt.omp.thinking.minimal": "ការគិត៖ តិចបំផុត",
  "prompt.omp.thinking.low": "ការគិត៖ ទាប",
  "prompt.omp.thinking.medium": "ការគិត៖ មធ្យម",
  "prompt.omp.thinking.high": "ការគិត៖ ខ្ពស់",
  "prompt.omp.thinking.xhigh": "ការគិត៖ ខ្ពស់ខ្លាំង",
  "prompt.omp.thinking.max": "ការគិត៖ អតិបរមា",
  "prompt.omp.advisor.title": "ទីប្រឹក្សា",
  "prompt.omp.advisor.on": "ទីប្រឹក្សា៖ បើក",
  "prompt.omp.advisor.off": "ទីប្រឹក្សា៖ បិទ",
  "prompt.omp.approval.title": "ការអនុម័តឧបករណ៍",
  "prompt.omp.approval.alwaysAsk": "ការអនុម័ត៖ សួរ",
  "prompt.omp.approval.write": "ការអនុម័ត៖ សរសេរ",
  "prompt.omp.approval.yolo": "ការអនុម័ត៖ YOLO",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ OMP ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "help.tabs.date": "ទិដ្ឋភាពទូទៅនៃមុខងារ",
  "help.tabs.introduction": "ផ្ទាំងជួយរៀបចំការងារ និងសម័យដែលកំពុងដំណើរការ។",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "worktree គឺជាថតការងារដាច់ដោយឡែកសម្រាប់គម្រោងមួយ។",
  ...
  "toast.update.description": "កំណែថ្មីនៃ OMP ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.chain.checkConfig": "សូមពិនិត្យឈ្មោះអ្នកផ្តល់សេវា និងម៉ូដែលដែលបានកំណត់រចនាសម្ព័ន្ធ។",
  "error.chain.mcpFailed": "ម៉ាស៊ីនមេ MCP \"{{name}}\" បានបរាជ័យ។",
  ...
  "sidebar.gettingStarted.line1": "បើកគម្រោងមួយដើម្បីចាប់ផ្តើម។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ OMP",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល OMP មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ OMP ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល OMP មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល OMP ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ OMP ។",
  ...
  "settings.metadata.scope.user": "អ្នកប្រើ",
  "settings.metadata.scope.project": "គម្រោង",
  "settings.metadata.scope.native": "ដើម",
  "settings.metadata.scope.global": "សកល",
  "settings.metadata.pluginKind.marketplace": "ទីផ្សារ",
