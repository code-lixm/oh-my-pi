...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP kunde inte läsas in",
  "desktop.recovery.terminated": "OMP-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "OMP svarar inte",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av OMP",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i OMP.",
  ...
  "prompt.omp.thinking.title": "Resonemangsinsats",
  "prompt.omp.thinking.off": "Resonemang: Av",
  "prompt.omp.thinking.auto": "Resonemang: Automatiskt",
  "prompt.omp.thinking.minimal": "Resonemang: Minimal",
  "prompt.omp.thinking.low": "Resonemang: Låg",
  "prompt.omp.thinking.medium": "Resonemang: Medel",
  "prompt.omp.thinking.high": "Resonemang: Hög",
  "prompt.omp.thinking.xhigh": "Resonemang: Extra hög",
  "prompt.omp.thinking.max": "Resonemang: Maximal",
  "prompt.omp.advisor.title": "Rådgivare",
  "prompt.omp.advisor.on": "Rådgivare: På",
  "prompt.omp.advisor.off": "Rådgivare: Av",
  "prompt.omp.approval.title": "Godkännande av verktyg",
  "prompt.omp.approval.alwaysAsk": "Godkännande: Fråga alltid",
  "prompt.omp.approval.write": "Godkännande: Skrivning",
  "prompt.omp.approval.yolo": "Godkännande: YOLO",
  ...
  "dialog.server.description": "Växla vilken OMP-server som denna app ansluter till.",
  ...
  "help.tabs.date": "Funktionsöversikt",
  "help.tabs.introduction": "Flikar organiserar arbete och aktiva sessioner.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Ett worktree är en separat arbetskatalog för ett projekt.",
  ...
  "toast.update.description": "En ny version av OMP ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.chain.checkConfig": "Kontrollera namnen på den konfigurerade leverantören och modellen.",
  "error.chain.mcpFailed": "MCP-servern \"{{name}}\" misslyckades.",
  ...
  "sidebar.gettingStarted.line1": "Öppna ett projekt för att komma igång.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för OMP",
  ...
  "settings.general.row.appearance.description": "Anpassa hur OMP ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om OMP följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa OMPs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när OMP startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av OMP.",
  ...
  "settings.metadata.scope.user": "Användare",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Inbyggd",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Marknadsplats",
