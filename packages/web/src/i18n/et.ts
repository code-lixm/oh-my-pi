...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP laadimine ebaõnnestus",
  "desktop.recovery.terminated": "OMP aken suleti ootamatult",
  "desktop.recovery.unresponsive": "OMP ei vasta",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub OMP",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid OMP'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises OMP.",
  ...
  "prompt.omp.thinking.title": "Arutluskäigu intensiivsus",
  "prompt.omp.thinking.off": "Arutluskäik: Väljas",
  "prompt.omp.thinking.auto": "Arutluskäik: Automaatne",
  "prompt.omp.thinking.minimal": "Arutluskäik: Minimaalne",
  "prompt.omp.thinking.low": "Arutluskäik: Madal",
  "prompt.omp.thinking.medium": "Arutluskäik: Keskmine",
  "prompt.omp.thinking.high": "Arutluskäik: Kõrge",
  "prompt.omp.thinking.xhigh": "Arutluskäik: Väga kõrge",
  "prompt.omp.thinking.max": "Arutluskäik: Maksimaalne",
  "prompt.omp.advisor.title": "Nõustaja",
  "prompt.omp.advisor.on": "Nõustaja: Sees",
  "prompt.omp.advisor.off": "Nõustaja: Väljas",
  "prompt.omp.approval.title": "Tööriistade kinnitus",
  "prompt.omp.approval.alwaysAsk": "Kinnitus: Küsi",
  "prompt.omp.approval.write": "Kinnitus: Kirjutamine",
  "prompt.omp.approval.yolo": "Kinnitus: YOLO",
  ...
  "dialog.server.description": "Lülitage, millise OMP serveriga see rakendus ühenduse loob.",
  ...
  "help.tabs.date": "Funktsioonide ülevaade",
  "help.tabs.introduction": "Vahekaardid korrastavad tööd ja aktiivseid seansse.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree on projekti eraldi töökataloog.",
  ...
  "toast.update.description": "Rakenduse OMP ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.chain.checkConfig": "Kontrollige seadistatud teenusepakkuja ja mudeli nimesid.",
  "error.chain.mcpFailed": "MCP-serveri „{{name}}” töö nurjus.",
  ...
  "sidebar.gettingStarted.line1": "Alustamiseks avage projekt.",
  ...
  "settings.general.row.language.description": "Muutke OMP kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas OMP teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas OMP järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas OMP on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui OMP käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse OMP uusimat versiooni.",
  ...
  "settings.metadata.scope.user": "Kasutaja",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Natiivne",
  "settings.metadata.scope.global": "Globaalne",
  "settings.metadata.pluginKind.marketplace": "Turuplats",
