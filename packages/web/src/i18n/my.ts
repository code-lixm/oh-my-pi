...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP ကို ဖွင့်၍မရပါ။",
  "desktop.recovery.terminated": "OMP ဝင်းဒိုးသည် မမျှော်လင့်ဘဲ ပိတ်သွားသည်။",
  "desktop.recovery.unresponsive": "OMP သည် တုံ့ပြန်ခြင်းမရှိပါ။",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP မှ ပံ့ပိုးပေးသော အခမဲ့မော်ဒယ်များ",
  ...
  "provider.connect.apiKey.description":
    "သင့်အကောင့်ကို ချိတ်ဆက်ရန်နှင့် OMP တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် သင်၏ {{provider}} API သော့ကို ထည့်သွင်းပါ။",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " သို့သွားပြီး သင့်အကောင့်ကို ချိတ်ဆက်ကာ OMP တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် ခွင့်ပြုချက်ကုဒ်ကို ရယူပါ။",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "နှင့် သင့်အကောင့်ကို ချိတ်ဆက်ပြီး OMP တွင် {{provider}} မော်ဒယ်များကို အသုံးပြုရန် အောက်ပါကုဒ်ကို ရိုက်ထည့်ပါ။",
  ...
  "prompt.omp.thinking.title": "စဉ်းစားမှု အားထုတ်မှု",
  "prompt.omp.thinking.off": "စဉ်းစားမှု: ပိတ်ထားသည်",
  "prompt.omp.thinking.auto": "စဉ်းစားမှု: အလိုအလျောက်",
  "prompt.omp.thinking.minimal": "စဉ်းစားမှု: အနည်းဆုံး",
  "prompt.omp.thinking.low": "စဉ်းစားမှု: နည်း",
  "prompt.omp.thinking.medium": "စဉ်းစားမှု: အလယ်အလတ်",
  "prompt.omp.thinking.high": "စဉ်းစားမှု: မြင့်",
  "prompt.omp.thinking.xhigh": "စဉ်းစားမှု: အလွန်မြင့်",
  "prompt.omp.thinking.max": "စဉ်းစားမှု: အများဆုံး",
  "prompt.omp.advisor.title": "အကြံပေး",
  "prompt.omp.advisor.on": "အကြံပေး: ဖွင့်ထားသည်",
  "prompt.omp.advisor.off": "အကြံပေး: ပိတ်ထားသည်",
  "prompt.omp.approval.title": "ကိရိယာ အတည်ပြုခြင်း",
  "prompt.omp.approval.alwaysAsk": "အတည်ပြုခြင်း: မေးရန်",
  "prompt.omp.approval.write": "အတည်ပြုခြင်း: ရေးရန်",
  "prompt.omp.approval.yolo": "အတည်ပြုခြင်း: YOLO",
  ...
  "dialog.server.description": "ဤအက်ပ်နှင့်ချိတ်ဆက်သည့် OMP ဆာဗာကို ပြောင်းပါ။",
  ...
  "help.tabs.date": "လုပ်ဆောင်ချက်များ အနှစ်ချုပ်",
  "help.tabs.introduction": "တက်ဘ်များသည် အလုပ်များနှင့် လက်ရှိအသုံးပြုနေသော ဆက်ရှင်များကို စုစည်းပေးသည်။",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "worktree သည် ပရောဂျက်တစ်ခုအတွက် သီးခြားအလုပ်လမ်းညွှန်တစ်ခု ဖြစ်သည်။",
  ...
  "toast.update.description": "OMP ({{version}}) ၏ ဗားရှင်းအသစ်ကို ယခု ထည့်သွင်းနိုင်ပါပြီ။",
  ...
  "error.chain.checkConfig": "သတ်မှတ်ထားသော ဝန်ဆောင်မှုပေးသူနှင့် မော်ဒယ်အမည်များကို စစ်ဆေးပါ။",
  "error.chain.mcpFailed":
    "MCP ဆာဗာ \"{{name}}\" မအောင်မြင်ပါ။",
  ...
  "sidebar.gettingStarted.line1": "စတင်ရန် ပရောဂျက်တစ်ခုကို ဖွင့်ပါ။",
  ...
  "settings.general.row.language.description": "OMP အတွက် ဖော်ပြသည့် ဘာသာစကားကို ပြောင်းပါ။",
  ...
  "settings.general.row.appearance.description": "သင့်စက်ပေါ်တွင် OMP ကို မည်သို့မြင်သည်ကို စိတ်ကြိုက်ပြင်ဆင်ပါ။",
  "settings.general.row.colorScheme.title": "အရောင်အစီအစဉ်",
  "settings.general.row.colorScheme.description":
    "OMP သည် စနစ်၊ အလင်း သို့မဟုတ် အမှောင် အပြင်အဆင်ကို လိုက်နာခြင်း ရှိ၊ မရှိကို ရွေးပါ။",
  "settings.general.row.theme.title": "အပြင်အဆင်",
  "settings.general.row.theme.description": "OMP ကို ဘယ်လိုပုံစံနဲ့ စိတ်ကြိုက်လုပ်မလဲ။",
  ...
  "settings.updates.row.startup.description": "OMP စတင်သည့်အခါ အပ်ဒိတ်များအတွက် အလိုအလျောက်စစ်ဆေးပါ။",
  ...
  "settings.updates.toast.latest.description": "သင်သည် OMP ၏ နောက်ဆုံးဗားရှင်းကို အသုံးပြုနေပါသည်။",
  ...
  "settings.metadata.scope.user": "အသုံးပြုသူ",
  "settings.metadata.scope.project": "ပရောဂျက်",
  "settings.metadata.scope.native": "မူလ",
  "settings.metadata.scope.global": "ကမ္ဘာလုံးဆိုင်ရာ",
  "settings.metadata.pluginKind.marketplace": "ဈေးကွက်",
