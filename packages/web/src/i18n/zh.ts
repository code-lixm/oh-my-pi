import { OMP_RUNTIME_ENGLISH, OMP_SETTINGS_ENGLISH } from "../../shared/omp-i18n-english"
...
export const dict = {
  ...
  "desktop.menu.documentation": "OMP 文档",
  "desktop.menu.shareFeedback": "提供反馈",
  "desktop.menu.reportBug": "报告错误",
  "desktop.menu.ariaLabel": "OMP 菜单",
  ...
  "desktop.recovery.loadFailed": "OMP 加载失败",
  "desktop.recovery.terminated": "OMP 窗口意外终止",
  "desktop.recovery.unresponsive": "OMP 未响应",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 OMP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 获取授权码，以连接你的账户并在 OMP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的账户并在 OMP 中使用 {{provider}} 模型。",
  ...
  "prompt.omp.thinking.title": "思考强度",
  "prompt.omp.thinking.off": "思考：关闭",
  "prompt.omp.thinking.auto": "思考：自动",
  "prompt.omp.thinking.minimal": "思考：最小",
  "prompt.omp.thinking.low": "思考：低",
  "prompt.omp.thinking.medium": "思考：中",
  "prompt.omp.thinking.high": "思考：高",
  "prompt.omp.thinking.xhigh": "思考：极高",
  "prompt.omp.thinking.max": "思考：最大",
  "prompt.omp.advisor.title": "审阅助手",
  "prompt.omp.advisor.on": "审阅：开启",
  "prompt.omp.advisor.off": "审阅：关闭",
  "prompt.omp.approval.title": "工具审批",
  "prompt.omp.approval.alwaysAsk": "审批：询问",
  "prompt.omp.approval.write": "审批：写入",
  "prompt.omp.approval.yolo": "审批：YOLO",
  ...
  "dialog.server.description": "切换此应用连接的 OMP 服务器。",
  ...
  "help.tabs.date": "功能概览",
  "help.tabs.introduction": "标签页用于组织工作和活跃会话。",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees": "工作树是项目的一个独立工作目录。",
  ...
  "toast.update.description": "OMP 有新版本 ({{version}}) 可安装。",
  ...
  "error.chain.checkConfig": "请检查已配置的提供商和模型名称。",
  "error.chain.mcpFailed": "MCP 服务器“{{name}}”运行失败。",
  ...
  "sidebar.gettingStarted.line1": "打开一个项目以开始使用。",
  ...
  "app.name.desktop": "OMP Desktop",
  "app.name.web": "OMP Web",

  "settings.section.desktop": "桌面",
  "settings.section.server": "服务器",
  "settings.section.shared": "OMP 通用",
  "settings.section.cli": "OMP CLI",
  "settings.scope.shared.title": "Web 与 CLI 共用配置",
  "settings.scope.shared.description":
    "这些值写入 OMP 的规范配置，由 Web 会话与 CLI 共用。运行时设置可能需要重启已运行会话后生效。",
  "settings.scope.shared.nav": "通用",
  "settings.scope.web.nav": "Web",
  "settings.scope.cli.nav": "CLI",
  "settings.scope.cli.title": "CLI/TUI 专用配置",
  "settings.scope.cli.description":
    "这些设置仅用于终端 CLI/TUI，不会改变 OMP Web 界面。已运行的 CLI 会话可能需要重新启动。",
  "settings.scope.cli.shortcuts":
    "这些快捷键仅用于 OMP CLI/TUI。浏览器和桌面端快捷键请在 OMP Web 中配置。",

  "settings.tab.general": "通用",
  "settings.tab.shortcuts": "快捷键",
  "settings.tab.webShortcuts": "Web 快捷键",
  "settings.tab.cliShortcuts": "CLI 快捷键",
  ...
  "settings.general.row.language.description": "更改 OMP 的显示语言",
  ...
  "settings.general.row.theme.description": "自定义 OMP 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OMP 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OMP。",
  ...
  "settings.metadata.scope.user": "用户",
  "settings.metadata.scope.project": "项目",
  "settings.metadata.scope.native": "原生",
  "settings.metadata.scope.global": "全局",
  "settings.metadata.pluginKind.marketplace": "插件市场",
  "settings.metadata.pluginKind.npm": "npm",
  ...
  "session.ompRuntime.title": "OMP 运行时",
  "session.ompRuntime.trigger": "打开 OMP 运行时",
  "session.ompRuntime.status": "运行时状态",
  "session.ompRuntime.refresh": "刷新",
  "session.ompRuntime.loading": "正在加载运行时…",
  "session.ompRuntime.loadError": "无法加载运行时。",
  "session.ompRuntime.retry": "重试",
  "session.ompRuntime.empty": "此会话没有可用的运行时详情。",
  "session.ompRuntime.actionFailed": "运行时操作失败",
  "session.ompRuntime.exported": "导出已就绪",
  "session.ompRuntime.exportPath": "导出路径",
  "session.ompRuntime.exportPathUnavailable": "未返回导出路径。",
  "session.ompRuntime.runtime.active": "活跃",
  "session.ompRuntime.runtime.parked": "已暂停",
  "session.ompRuntime.runtime.resuming": "正在恢复",
  "session.ompRuntime.state": "状态",
  "session.ompRuntime.model": "模型",
  "session.ompRuntime.streaming": "流式输出",
  "session.ompRuntime.bashRunning": "Bash 运行中",
  "session.ompRuntime.evalRunning": "Eval 运行中",
  "session.ompRuntime.compacting": "正在压缩",
  "session.ompRuntime.queued": "排队中",
  "session.ompRuntime.messages": "消息",
  "session.ompRuntime.tps": "Token / 秒",
  "session.ompRuntime.contextUsage": "上下文用量",
  "session.ompRuntime.lsp": "LSP",
  "session.ompRuntime.lspServices": "{{count}} 个服务",
  "session.ompRuntime.lspUnavailable": "不可用",
  "session.ompRuntime.unavailable": "不可用",
  "session.ompRuntime.enabled": "已启用",
  "session.ompRuntime.disabled": "未启用",
  "session.ompRuntime.activity": "当前活动",
  "session.ompRuntime.activityEmpty": "没有活跃的运行时活动。",
  "session.ompRuntime.activityPhase": "阶段",
  "session.ompRuntime.activityLabel": "标签",
  "session.ompRuntime.activityDetail": "详情",
  "session.ompRuntime.modes": "模式",
  "session.ompRuntime.planMode": "计划",
  "session.ompRuntime.goalMode": "目标",
  "session.ompRuntime.vibeMode": "氛围",
  "session.ompRuntime.tools": "可用工具",
  "session.ompRuntime.toolsEmpty": "没有可用工具。",
  "session.ompRuntime.toolsMore": "另有 {{count}} 个工具",
  "session.ompRuntime.todos": "待办事项",
  "session.ompRuntime.todosEmpty": "没有待办事项",
  "session.ompRuntime.todosSummary": "已完成 {{done}} / {{total}}",
  "session.ompRuntime.subagents": "子代理",
  "session.ompRuntime.subagentsEmpty": "没有子代理。",
  "session.ompRuntime.subagentUnnamed": "子代理 {{count}}",
  "session.ompRuntime.itemsMore": "另有 {{count}} 项",
  "session.ompRuntime.jobs": "任务",
  "session.ompRuntime.jobsEmpty": "没有任务。",
  "session.ompRuntime.jobUnnamed": "任务 {{count}}",
  "session.ompRuntime.providers": "登录提供方",
  "session.ompRuntime.providersEmpty": "没有登录提供方。",
  "session.ompRuntime.providerAuthenticated": "已认证",
  "session.ompRuntime.providerAvailable": "可用",
  "session.ompRuntime.providerUnavailable": "不可用",
  "session.ompRuntime.actions": "操作",
  "session.ompRuntime.checkpointCreate": "创建检查点",
  "session.ompRuntime.checkpointUndo": "撤销",
  "session.ompRuntime.checkpointRedo": "重做",
  "session.ompRuntime.abortAgent": "中止代理",
  "session.ompRuntime.abortBash": "中止 Bash",
  "session.ompRuntime.cancelJobs": "取消任务",
  "session.ompRuntime.export": "导出",
  "session.ompRuntime.checkpointCreated": "已创建检查点",
  "session.ompRuntime.checkpointUndone": "已完成撤销",
  "session.ompRuntime.checkpointRedone": "已完成重做",
  "session.ompRuntime.agentAborted": "已请求中止代理",
  "session.ompRuntime.bashAborted": "已请求中止 Bash",
  "session.ompRuntime.jobsCancelled": "已请求取消任务",
