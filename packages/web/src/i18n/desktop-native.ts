...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "OMP failed to load",
  "desktop.recovery.terminated": "OMP window terminated unexpectedly",
  "desktop.recovery.unresponsive": "OMP is not responding",
