...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل OMP",
  "desktop.recovery.terminated": "توقفت نافذة OMP بشكل غير متوقع",
  "desktop.recovery.unresponsive": "OMP لا يستجيب",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OMP",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OMP.",
  ...
  "prompt.omp.thinking.title": "مستوى التفكير",
  "prompt.omp.thinking.off": "التفكير: متوقف",
  "prompt.omp.thinking.auto": "التفكير: تلقائي",
  "prompt.omp.thinking.minimal": "التفكير: أدنى",
  "prompt.omp.thinking.low": "التفكير: منخفض",
  "prompt.omp.thinking.medium": "التفكير: متوسط",
  "prompt.omp.thinking.high": "التفكير: مرتفع",
  "prompt.omp.thinking.xhigh": "التفكير: مرتفع جدًا",
  "prompt.omp.thinking.max": "التفكير: أقصى",
  "prompt.omp.advisor.title": "المستشار",
  "prompt.omp.advisor.on": "المستشار: مفعّل",
  "prompt.omp.advisor.off": "المستشار: متوقف",
  "prompt.omp.approval.title": "الموافقة على الأدوات",
  "prompt.omp.approval.alwaysAsk": "الموافقة: طلب الإذن",
  "prompt.omp.approval.write": "الموافقة: كتابة",
  "prompt.omp.approval.yolo": "الموافقة: YOLO",
  ...
  "dialog.server.description": "تبديل خادم OMP الذي يتصل به هذا التطبيق.",
  ...
  "help.tabs.date": "نظرة عامة على الميزات",
  "help.tabs.introduction": "تنظّم علامات التبويب العمل والجلسات النشطة.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "‏Worktree هو دليل عمل منفصل لمشروع ما.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من OMP ({{version}}) للتثبيت.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر والنموذج المُكوَّنين.",
  "error.chain.mcpFailed": "فشل خادم MCP «{{name}}».",
  ...
  "sidebar.gettingStarted.line1": "افتح مشروعًا للبدء.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OMP",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OMP على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OMP يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OMP.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OMP",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OMP.",
  ...
  "settings.metadata.scope.user": "المستخدم",
  "settings.metadata.scope.project": "المشروع",
  "settings.metadata.scope.native": "أصلي",
  "settings.metadata.scope.global": "عالمي",
  "settings.metadata.pluginKind.marketplace": "السوق",
