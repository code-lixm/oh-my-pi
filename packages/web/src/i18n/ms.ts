...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi OMP",
  ...
  "desktop.recovery.loadFailed": "OMP gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap OMP ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "OMP tidak memberi respons",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh OMP",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam OMP.",
  ...
  "prompt.omp.thinking.title": "Usaha pemikiran",
  "prompt.omp.thinking.off": "Pemikiran: Tidak aktif",
  "prompt.omp.thinking.auto": "Pemikiran: Automatik",
  "prompt.omp.thinking.minimal": "Pemikiran: Minimum",
  "prompt.omp.thinking.low": "Pemikiran: Rendah",
  "prompt.omp.thinking.medium": "Pemikiran: Sederhana",
  "prompt.omp.thinking.high": "Pemikiran: Tinggi",
  "prompt.omp.thinking.xhigh": "Pemikiran: Sangat tinggi",
  "prompt.omp.thinking.max": "Pemikiran: Maksimum",
  "prompt.omp.advisor.title": "Penasihat",
  "prompt.omp.advisor.on": "Penasihat: Aktif",
  "prompt.omp.advisor.off": "Penasihat: Tidak aktif",
  "prompt.omp.approval.title": "Kelulusan alat",
  "prompt.omp.approval.alwaysAsk": "Kelulusan: Tanya",
  "prompt.omp.approval.write": "Kelulusan: Tulis",
  "prompt.omp.approval.yolo": "Kelulusan: YOLO",
  ...
  "dialog.server.description": "Tukar pelayan OMP yang disambungkan oleh aplikasi ini.",
  ...
  "help.tabs.date": "Gambaran keseluruhan ciri",
  "help.tabs.introduction": "Tab menyusun kerja dan sesi aktif.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree ialah direktori kerja yang berasingan untuk sesuatu projek.",
  ...
  "toast.update.description": "Versi baharu OMP ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.chain.checkConfig": "Semak nama penyedia dan model yang dikonfigurasikan.",
  "error.chain.mcpFailed": "Pelayan MCP \"{{name}}\" gagal.",
  ...
  "sidebar.gettingStarted.line1": "Buka projek untuk bermula.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk OMP",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa OMP pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada OMP mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema OMP.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila OMP dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini OMP.",
  ...
  "settings.metadata.scope.user": "Pengguna",
  "settings.metadata.scope.project": "Projek",
  "settings.metadata.scope.native": "Asli",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Pasaran",
