...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "OMP պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "OMP-ը չի արձագանքում",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են OMP",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և OMP-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և OMP-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և OMP-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "prompt.omp.thinking.title": "Մտածողության ջանք",
  "prompt.omp.thinking.off": "Մտածողություն՝ Անջատված",
  "prompt.omp.thinking.auto": "Մտածողություն՝ Ավտոմատ",
  "prompt.omp.thinking.minimal": "Մտածողություն՝ Նվազագույն",
  "prompt.omp.thinking.low": "Մտածողություն՝ Ցածր",
  "prompt.omp.thinking.medium": "Մտածողություն՝ Միջին",
  "prompt.omp.thinking.high": "Մտածողություն՝ Բարձր",
  "prompt.omp.thinking.xhigh": "Մտածողություն՝ Շատ բարձր",
  "prompt.omp.thinking.max": "Մտածողություն՝ Առավելագույն",
  "prompt.omp.advisor.title": "Խորհրդատու",
  "prompt.omp.advisor.on": "Խորհրդատու՝ Միացված",
  "prompt.omp.advisor.off": "Խորհրդատու՝ Անջատված",
  "prompt.omp.approval.title": "Գործիքի հաստատում",
  "prompt.omp.approval.alwaysAsk": "Հաստատում՝ Հարցրեք",
  "prompt.omp.approval.write": "Հաստատում՝ Գրել",
  "prompt.omp.approval.yolo": "Հաստատում՝ YOLO",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ OMP սերվերին է միանում այս հավելվածը։",
  ...
  "help.tabs.date": "Գործառույթի ակնարկ",
  "help.tabs.introduction": "Ներդիրները կազմակերպում են աշխատանքը և ակտիվ աշխատաշրջանները։",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree-ը նախագծի հետ կապված առանձին աշխատանքային գրացուցակ է։",
  ...
  "toast.update.description": "OMP-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.chain.checkConfig": "Ստուգեք կազմաձևված մատակարարի և մոդելի անունները։",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերի աշխատանքը ձախողվեց։",
  ...
  "sidebar.gettingStarted.line1": "Սկսելու համար բացեք նախագիծ։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն OMP",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է OMP տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ OMP-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է OMP-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ OMP-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք OMP-ի վերջին տարբերակը։",
  ...
  "settings.metadata.scope.user": "Օգտատեր",
  "settings.metadata.scope.project": "Նախագիծ",
  "settings.metadata.scope.native": "Բնիկ",
  "settings.metadata.scope.global": "Համաշխարհային",
  "settings.metadata.pluginKind.marketplace": "Շուկա",
