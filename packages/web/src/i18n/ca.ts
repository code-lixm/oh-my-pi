...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra OMP s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "OMP no respon",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per OMP",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a OMP.",
  ...
  "prompt.omp.thinking.title": "Esforç de raonament",
  "prompt.omp.thinking.off": "Raonament: Desactivat",
  "prompt.omp.thinking.auto": "Raonament: Automàtic",
  "prompt.omp.thinking.minimal": "Raonament: Mínim",
  "prompt.omp.thinking.low": "Raonament: Baix",
  "prompt.omp.thinking.medium": "Raonament: Mitjà",
  "prompt.omp.thinking.high": "Raonament: Alt",
  "prompt.omp.thinking.xhigh": "Raonament: Molt alt",
  "prompt.omp.thinking.max": "Raonament: Màxim",
  "prompt.omp.advisor.title": "Assessor",
  "prompt.omp.advisor.on": "Assessor: Activat",
  "prompt.omp.advisor.off": "Assessor: Desactivat",
  "prompt.omp.approval.title": "Aprovació d'eines",
  "prompt.omp.approval.alwaysAsk": "Aprovació: Pregunta",
  "prompt.omp.approval.write": "Aprovació: Escriptura",
  "prompt.omp.approval.yolo": "Aprovació: YOLO",
  ...
  "dialog.server.description": "Canvia a quin OMP servidor es connecta aquesta aplicació.",
  ...
  "help.tabs.date": "Visió general de les funcions",
  "help.tabs.introduction": "Les pestanyes organitzen la feina i les sessions actives.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Un worktree és un directori de treball separat per a un projecte.",
  ...
  "toast.update.description": "Una nova versió de OMP ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del proveïdor i del model configurats.",
  "error.chain.mcpFailed":
    "El servidor MCP «{{name}}» ha fallat.",
  ...
  "sidebar.gettingStarted.line1": "Obriu un projecte per començar.",
  ...
  "app.name.desktop": "OMP Escriptori",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a OMP",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu OMP al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si OMP segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de OMP.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï OMP.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de OMP.",
  ...
  "settings.metadata.scope.user": "Usuari",
  "settings.metadata.scope.project": "Projecte",
  "settings.metadata.scope.native": "Natiu",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Mercat",
