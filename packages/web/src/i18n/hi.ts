...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP लोड नहीं हो सका",
  "desktop.recovery.terminated": "OMP विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "OMP प्रतिसाद नहीं दे रहा है",
  ...
  "dialog.model.unpaid.freeModels.title": "OMP द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और OMP में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और OMP में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा OMP में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "prompt.omp.thinking.title": "सोचने का स्तर",
  "prompt.omp.thinking.off": "सोच: बंद",
  "prompt.omp.thinking.auto": "सोच: स्वचालित",
  "prompt.omp.thinking.minimal": "सोच: न्यूनतम",
  "prompt.omp.thinking.low": "सोच: कम",
  "prompt.omp.thinking.medium": "सोच: मध्यम",
  "prompt.omp.thinking.high": "सोच: उच्च",
  "prompt.omp.thinking.xhigh": "सोच: बहुत उच्च",
  "prompt.omp.thinking.max": "सोच: अधिकतम",
  "prompt.omp.advisor.title": "सलाहकार",
  "prompt.omp.advisor.on": "सलाहकार: चालू",
  "prompt.omp.advisor.off": "सलाहकार: बंद",
  "prompt.omp.approval.title": "टूल अनुमोदन",
  "prompt.omp.approval.alwaysAsk": "अनुमोदन: पूछें",
  "prompt.omp.approval.write": "अनुमोदन: लिखें",
  "prompt.omp.approval.yolo": "अनुमोदन: YOLO",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस OMP सर्वर से कनेक्ट होता है।",
  ...
  "help.tabs.date": "सुविधा का अवलोकन",
  "help.tabs.introduction": "टैब काम और सक्रिय सत्रों को व्यवस्थित करते हैं।",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "वर्कट्री किसी प्रोजेक्ट से जुड़ी एक अलग वर्किंग डायरेक्टरी है।",
  ...
  "toast.update.description": "OMP ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.chain.checkConfig": "कॉन्फ़िगर किए गए प्रोवाइडर और मॉडल के नाम जाँचें।",
  "error.chain.mcpFailed":
    "MCP सर्वर \"{{name}}\" विफल रहा।",
  ...
  "sidebar.gettingStarted.line1": "शुरू करने के लिए कोई प्रोजेक्ट खोलें।",
  ...
  "settings.general.row.language.description": "OMP के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि OMP आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि OMP सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि OMP की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "OMP लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप OMP का नवीनतम संस्करण चला रहे हैं।",
  ...
  "settings.metadata.scope.user": "उपयोगकर्ता",
  "settings.metadata.scope.project": "प्रोजेक्ट",
  "settings.metadata.scope.native": "मूल",
  "settings.metadata.scope.global": "वैश्विक",
  "settings.metadata.pluginKind.marketplace": "बाज़ार",
