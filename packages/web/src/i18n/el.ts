...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "OMP το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "OMP δεν αποκρίνεται",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από OMP",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο OMP.",
  ...
  "prompt.omp.thinking.title": "Ένταση συλλογισμού",
  "prompt.omp.thinking.off": "Συλλογισμός: Απενεργοποιημένος",
  "prompt.omp.thinking.auto": "Συλλογισμός: Αυτόματος",
  "prompt.omp.thinking.minimal": "Συλλογισμός: Ελάχιστος",
  "prompt.omp.thinking.low": "Συλλογισμός: Χαμηλός",
  "prompt.omp.thinking.medium": "Συλλογισμός: Μέτριος",
  "prompt.omp.thinking.high": "Συλλογισμός: Υψηλός",
  "prompt.omp.thinking.xhigh": "Συλλογισμός: Πολύ υψηλός",
  "prompt.omp.thinking.max": "Συλλογισμός: Μέγιστος",
  "prompt.omp.advisor.title": "Σύμβουλος",
  "prompt.omp.advisor.on": "Σύμβουλος: Ενεργός",
  "prompt.omp.advisor.off": "Σύμβουλος: Ανενεργός",
  "prompt.omp.approval.title": "Έγκριση εργαλείων",
  "prompt.omp.approval.alwaysAsk": "Έγκριση: Ερώτηση",
  "prompt.omp.approval.write": "Έγκριση: Εγγραφή",
  "prompt.omp.approval.yolo": "Έγκριση: YOLO",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή OMP συνδέεται αυτή η εφαρμογή.",
  ...
  "help.tabs.date": "Επισκόπηση δυνατοτήτων",
  "help.tabs.introduction": "Οι καρτέλες οργανώνουν την εργασία και τις ενεργές συνεδρίες.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Ένα worktree είναι ένας ξεχωριστός κατάλογος εργασίας για ένα έργο.",
  ...
  "toast.update.description": "Μια νέα έκδοση του OMP ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.chain.checkConfig": "Ελέγξτε τα ονόματα του ρυθμισμένου παρόχου και μοντέλου.",
  "error.chain.mcpFailed":
    "Ο διακομιστής MCP «{{name}}» απέτυχε.",
  ...
  "sidebar.gettingStarted.line1": "Ανοίξτε ένα έργο για να ξεκινήσετε.",
  ...
  "app.name.desktop": "OMP Επιτραπέζιος υπολογιστής",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το OMP",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του OMP στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το OMP ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το OMP.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του OMP",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του OMP.",
  ...
  "settings.metadata.scope.user": "Χρήστης",
  "settings.metadata.scope.project": "Έργο",
  "settings.metadata.scope.native": "Εγγενές",
  "settings.metadata.scope.global": "Καθολικό",
  "settings.metadata.pluginKind.marketplace": "Αγορά",
