...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor OMP-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "OMP ne reaguje",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OMP",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OMP-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OMP-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OMP-u.",
  ...
  "prompt.omp.thinking.title": "Nivo razmišljanja",
  "prompt.omp.thinking.off": "Razmišljanje: Isključeno",
  "prompt.omp.thinking.auto": "Razmišljanje: Automatski",
  "prompt.omp.thinking.minimal": "Razmišljanje: Minimalno",
  "prompt.omp.thinking.low": "Razmišljanje: Nisko",
  "prompt.omp.thinking.medium": "Razmišljanje: Srednje",
  "prompt.omp.thinking.high": "Razmišljanje: Visoko",
  "prompt.omp.thinking.xhigh": "Razmišljanje: Izuzetno visoko",
  "prompt.omp.thinking.max": "Razmišljanje: Maksimalno",
  "prompt.omp.advisor.title": "Savjetnik",
  "prompt.omp.advisor.on": "Savjetnik: Uključen",
  "prompt.omp.advisor.off": "Savjetnik: Isključen",
  "prompt.omp.approval.title": "Odobravanje alata",
  "prompt.omp.approval.alwaysAsk": "Odobravanje: Pitaj",
  "prompt.omp.approval.write": "Odobravanje: Pisanje",
  "prompt.omp.approval.yolo": "Odobravanje: YOLO",
  ...
  "dialog.server.description": "Promijeni na koji se OMP server ova aplikacija povezuje.",
  ...
  "help.tabs.date": "Pregled funkcija",
  "help.tabs.introduction": "Kartice organizuju rad i aktivne sesije.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree je zaseban radni direktorij za projekat.",
  ...
  "toast.update.description": "Nova verzija OMP-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.chain.checkConfig": "Provjerite nazive konfigurisanog provajdera i modela.",
  "error.chain.mcpFailed": "MCP server „{{name}}“ nije uspio.",
  ...
  "sidebar.gettingStarted.line1": "Otvorite projekat da biste počeli.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OMP-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OMP izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OMP prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OMP-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OMP pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OMP-a.",
  ...
  "settings.metadata.scope.user": "Korisnik",
  "settings.metadata.scope.project": "Projekat",
  "settings.metadata.scope.native": "Nativni",
  "settings.metadata.scope.global": "Globalni",
  "settings.metadata.pluginKind.marketplace": "Tržište",
