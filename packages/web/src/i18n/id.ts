...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP gagal dimuat",
  "desktop.recovery.terminated": "Jendela OMP berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "OMP tidak merespons",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh OMP",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di OMP.",
  ...
  "prompt.omp.thinking.title": "Intensitas berpikir",
  "prompt.omp.thinking.off": "Berpikir: Nonaktif",
  "prompt.omp.thinking.auto": "Berpikir: Otomatis",
  "prompt.omp.thinking.minimal": "Berpikir: Minimal",
  "prompt.omp.thinking.low": "Berpikir: Rendah",
  "prompt.omp.thinking.medium": "Berpikir: Sedang",
  "prompt.omp.thinking.high": "Berpikir: Tinggi",
  "prompt.omp.thinking.xhigh": "Berpikir: Sangat tinggi",
  "prompt.omp.thinking.max": "Berpikir: Maksimum",
  "prompt.omp.advisor.title": "Penasihat",
  "prompt.omp.advisor.on": "Penasihat: Aktif",
  "prompt.omp.advisor.off": "Penasihat: Nonaktif",
  "prompt.omp.approval.title": "Persetujuan alat",
  "prompt.omp.approval.alwaysAsk": "Persetujuan: Selalu tanyakan",
  "prompt.omp.approval.write": "Persetujuan: Tulis",
  "prompt.omp.approval.yolo": "Persetujuan: YOLO",
  ...
  "dialog.server.description": "Ganti server OMP mana yang terhubung dengan aplikasi ini.",
  ...
  "help.tabs.date": "Ringkasan fitur",
  "help.tabs.introduction": "Tab mengatur pekerjaan dan sesi aktif.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree adalah direktori kerja terpisah untuk sebuah proyek.",
  ...
  "toast.update.description": "Versi baru OMP ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia dan model yang dikonfigurasi.",
  "error.chain.mcpFailed": "Server MCP \"{{name}}\" gagal.",
  ...
  "sidebar.gettingStarted.line1": "Buka proyek untuk memulai.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk OMP",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan OMP di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah OMP mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat OMP diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru OMP.",
  ...
  "settings.metadata.scope.project": "Proyek",
  "settings.metadata.scope.native": "Asli",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Pasar",
