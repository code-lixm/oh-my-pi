...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OMP",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OMP.",
  ...
  "prompt.omp.thinking.title": "Thinking effort",
  "prompt.omp.thinking.off": "Thinking: Off",
  "prompt.omp.thinking.auto": "Thinking: Auto",
  "prompt.omp.thinking.minimal": "Thinking: Minimal",
  "prompt.omp.thinking.low": "Thinking: Low",
  "prompt.omp.thinking.medium": "Thinking: Medium",
  "prompt.omp.thinking.high": "Thinking: High",
  "prompt.omp.thinking.xhigh": "Thinking: Extra high",
  "prompt.omp.thinking.max": "Thinking: Max",
  "prompt.omp.advisor.title": "Advisor",
  "prompt.omp.advisor.on": "Advisor: On",
  "prompt.omp.advisor.off": "Advisor: Off",
  "prompt.omp.approval.title": "Tool approval",
  "prompt.omp.approval.alwaysAsk": "Approval: Ask",
  "prompt.omp.approval.write": "Approval: Write",
  "prompt.omp.approval.yolo": "Approval: YOLO",
  ...
  "dialog.server.description": "Switch which OMP server this app connects to.",
  ...
  "help.tabs.date": "Feature overview",
  "help.tabs.introduction": "Tabs organize work and active sessions.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "A worktree is a separate working directory for a project.",
  ...
  "toast.update.description":
    "A new version of OMP ({{version}}) is now available to install.",
  ...
  "error.chain.checkConfig": "Check the configured provider and model names.",
  ...
  "sidebar.gettingStarted.line1": "Open a project to get started.",
  ...
  "settings.general.row.language.description":
    "Change the display language for OMP",
  ...
  "settings.general.row.appearance.description":
    "Customise how OMP looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description":
    "Choose whether OMP follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OMP is themed.",
  ...
  "settings.updates.row.startup.description":
    "Automatically check for updates when OMP launches",
  ...
  "settings.updates.toast.latest.description":
    "You're running the latest version of OMP.",
  ...
  "settings.metadata.scope.user": "User",
  "settings.metadata.scope.project": "Project",
  "settings.metadata.scope.native": "Native",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Marketplace",
