...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "OMP kunne ikke lastes inn",
  "desktop.recovery.terminated": "OMP-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "OMP svarer ikke",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OMP",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OMP.",
  ...
  "prompt.omp.thinking.title": "Resonneringsinnsats",
  "prompt.omp.thinking.off": "Resonnering: Av",
  "prompt.omp.thinking.auto": "Resonnering: Automatisk",
  "prompt.omp.thinking.minimal": "Resonnering: Minimal",
  "prompt.omp.thinking.low": "Resonnering: Lav",
  "prompt.omp.thinking.medium": "Resonnering: Middels",
  "prompt.omp.thinking.high": "Resonnering: Høy",
  "prompt.omp.thinking.xhigh": "Resonnering: Ekstra høy",
  "prompt.omp.thinking.max": "Resonnering: Maksimal",
  "prompt.omp.advisor.title": "Rådgiver",
  "prompt.omp.advisor.on": "Rådgiver: På",
  "prompt.omp.advisor.off": "Rådgiver: Av",
  "prompt.omp.approval.title": "Godkjenning av verktøy",
  "prompt.omp.approval.alwaysAsk": "Godkjenning: Spør",
  "prompt.omp.approval.write": "Godkjenning: Skriving",
  "prompt.omp.approval.yolo": "Godkjenning: YOLO",
  ...
  "dialog.server.description": "Bytt hvilken OMP-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OMP ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.chain.checkConfig": "Kontroller navnene på den konfigurerte leverandøren og modellen.",
  "error.chain.mcpFailed": "MCP-serveren \"{{name}}\" mislyktes.",
  ...
  "sidebar.gettingStarted.line1": "Åpne et prosjekt for å komme i gang.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OMP",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OMP ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om OMP skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i OMP.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OMP starter",
  ...
  "settings.updates.toast.latest.title": "OMP er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OMP.",
  ...
  "settings.metadata.scope.user": "Bruker",
  "settings.metadata.scope.project": "Prosjekt",
  "settings.metadata.scope.native": "Innebygd",
  "settings.metadata.scope.global": "Global",
  "settings.metadata.pluginKind.marketplace": "Markedsplass",
  ...
  "help.tabs.date": "Funksjonsoversikt",
  "help.tabs.introduction": "Faner organiserer arbeid og aktive økter.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "En worktree er en separat arbeidskatalog for et prosjekt.",
