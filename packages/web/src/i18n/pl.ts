...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja OMP",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać OMP",
  "desktop.recovery.terminated": "Okno OMP zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "OMP nie odpowiada",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OMP",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OMP.",
  ...
  "prompt.omp.thinking.title": "Poziom rozumowania",
  "prompt.omp.thinking.off": "Rozumowanie: Wyłączone",
  "prompt.omp.thinking.auto": "Rozumowanie: Automatyczne",
  "prompt.omp.thinking.minimal": "Rozumowanie: Minimalne",
  "prompt.omp.thinking.low": "Rozumowanie: Niskie",
  "prompt.omp.thinking.medium": "Rozumowanie: Średnie",
  "prompt.omp.thinking.high": "Rozumowanie: Wysokie",
  "prompt.omp.thinking.xhigh": "Rozumowanie: Bardzo wysokie",
  "prompt.omp.thinking.max": "Rozumowanie: Maksymalne",
  "prompt.omp.advisor.title": "Doradca",
  "prompt.omp.advisor.on": "Doradca: Włączony",
  "prompt.omp.advisor.off": "Doradca: Wyłączony",
  "prompt.omp.approval.title": "Zatwierdzanie narzędzi",
  "prompt.omp.approval.alwaysAsk": "Zatwierdzanie: Zawsze pytaj",
  "prompt.omp.approval.write": "Zatwierdzanie: Zapis",
  "prompt.omp.approval.yolo": "Zatwierdzanie: YOLO",
  ...
  "dialog.server.description": "Przełącz serwer OMP, z którym łączy się ta aplikacja.",
  ...
  "help.tabs.date": "Przegląd funkcji",
  "help.tabs.introduction": "Karty porządkują pracę i aktywne sesje.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Worktree to osobny katalog roboczy projektu.",
  ...
  "toast.update.description": "Nowa wersja OMP ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy skonfigurowanego dostawcy i modelu.",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie zadziałał.",
  ...
  "sidebar.gettingStarted.line1": "Otwórz projekt, aby rozpocząć.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OMP",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OMP na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OMP ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OMP.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OMP",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OMP.",
  ...
  "settings.metadata.scope.user": "Użytkownik",
  "settings.metadata.scope.project": "Projekt",
  "settings.metadata.scope.native": "Natywny",
  "settings.metadata.scope.global": "Globalny",
  "settings.metadata.pluginKind.marketplace": "Rynek wtyczek",
