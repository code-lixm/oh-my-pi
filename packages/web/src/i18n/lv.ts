...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt OMP",
  "desktop.recovery.terminated": "OMP logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "OMP neatbild",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no OMP",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus OMP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus OMP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus OMP.",
  ...
  "prompt.omp.thinking.title": "Domāšanas piepūle",
  "prompt.omp.thinking.off": "Domāšana: Izslēgta",
  "prompt.omp.thinking.auto": "Domāšana: Automātiska",
  "prompt.omp.thinking.minimal": "Domāšana: Minimāla",
  "prompt.omp.thinking.low": "Domāšana: Zema",
  "prompt.omp.thinking.medium": "Domāšana: Vidēja",
  "prompt.omp.thinking.high": "Domāšana: Augsta",
  "prompt.omp.thinking.xhigh": "Domāšana: Īpaši augsta",
  "prompt.omp.thinking.max": "Domāšana: Maksimāla",
  "prompt.omp.advisor.title": "Padomdevējs",
  "prompt.omp.advisor.on": "Padomdevējs: Ieslēgts",
  "prompt.omp.advisor.off": "Padomdevējs: Izslēgts",
  "prompt.omp.approval.title": "Rīku apstiprināšana",
  "prompt.omp.approval.alwaysAsk": "Apstiprināšana: Jautāt",
  "prompt.omp.approval.write": "Apstiprināšana: Rakstīt",
  "prompt.omp.approval.yolo": "Apstiprināšana: YOLO",
  ...
  "dialog.server.description": "Mainiet, pie kura OMP servera šī lietotne pieslēdzas.",
  ...
  "help.tabs.date": "Funkciju pārskats",
  "help.tabs.introduction": "Cilnes palīdz organizēt darbu un aktīvās sesijas.",
  "help.tabs.sessions":
  ...
  "help.tabs.worktrees":
    "Darba koks ir atsevišķs projekta darba direktorijs.",
  ...
  "toast.update.description": "Pieejama jauna OMP versija ({{version}}) instalēšanai.",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurētā nodrošinātāja un modeļa nosaukumus.",
  "error.chain.mcpFailed":
    "MCP servera “{{name}}” darbība neizdevās.",
  ...
  "sidebar.gettingStarted.line1": "Lai sāktu, atveriet projektu.",
  ...
  "app.name.desktop": "OMP darbvirsma",
  ...
  "settings.general.row.language.description": "Mainīt OMP saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā OMP izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai OMP sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet OMP tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot OMP",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko OMP versiju.",
  ...
  "settings.metadata.scope.user": "Lietotājs",
  "settings.metadata.scope.project": "Projekts",
  "settings.metadata.scope.native": "Vietējais",
  "settings.metadata.scope.global": "Globāls",
  "settings.metadata.pluginKind.marketplace": "Tirgus vieta",
