...
type PlatformBase = {
  /** Application bundle version used for the Desktop app identity and updater metadata. */
  version?: string
  /** Running OMP coding-agent version reported by the connected backend health endpoint. */
  runtimeVersion?: Accessor<string | undefined>
