...
export const SettingsGeneral: Component = () => {
  ...
  const linux = createMemo(
    () => platform.platform === "desktop" && platform.os === "linux",
  );
  ...
  const [shells] = createResource(() => serverSdk().api.runtime.shells(), {
  ...
  const soundSelectProps = (
    ...
    current: enabled()
      ? (soundOptions.find((o) => o.id === current()) ?? noneSound)
      : noneSound,
      ...
      <SettingsList>
        ...
        >
          <Button
            size="small"
            variant="ghost"
            onClick={settings.general.dismissNewInterfaceNotice}
          >
      ...
      <SettingsList>
        ...
        >
          <Select
            ...
            current={languageOptions().find(
              (o) => o.value === language.locale(),
            )}
            value={(o) => o.value}
            label={(o) => o.label}
        ...
        >
          <Select
            ...
            current={
              shellOptions().find((o) => o.value === currentShell()) ??
              autoOption
            }
            value={(o) => o.id}
            label={(o) => o.label}
      ...
      <SettingsList>
        ...
        >
          <Select
            ...
            current={colorSchemeOptions().find(
              (o) => o.value === theme.colorScheme(),
            )}
            value={(o) => o.value}
            label={(o) => o.label}
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <ExternalLink href="https://github.com/can1357/oh-my-pi">
